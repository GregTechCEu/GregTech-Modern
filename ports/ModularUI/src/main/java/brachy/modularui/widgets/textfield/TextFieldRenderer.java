...
public class TextFieldRenderer extends TextRenderer {
    ...
    protected void drawMarked(GuiGraphicsExtractor graphics, List<Line> measuredLines) {
    ...
    @OnlyIn(Dist.CLIENT)
    private void drawCursor(GuiGraphicsExtractor graphics, float x0, float y0) {
