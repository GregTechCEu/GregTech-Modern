...
public class TextRenderer {
    ...
    public void draw(GuiGraphicsExtractor graphics, Component text) {
    ...
    public void draw(GuiGraphicsExtractor graphics, List<Component> lines) {
        drawMeasuredLines(graphics, measureLines(lines));
    }

    protected void drawMeasuredLines(GuiGraphicsExtractor graphics, List<Line> measuredLines) {
        float maxW = 0;
    ...
    public void drawSimple(GuiGraphicsExtractor graphics, Component text) {
        this.drawSimple(graphics, text.getVisualOrderText());
    }

    public void drawSimple(GuiGraphicsExtractor graphics, FormattedCharSequence text) {
    ...
    public void drawCompiled(GuiContext context, List<ITextLine> lines) {
        ...
        if (!this.simulate) {
            ...
            context.graphicsPose().translate(this.x, this.y);
    ...
    public void drawCut(GuiGraphicsExtractor graphics, String text) {
        if (text.contains("\n")) {
    ...
    public void drawCut(GuiGraphicsExtractor graphics, Line line) {
    ...
    public void drawScrolling(GuiGraphicsExtractor graphics, Line line, float progress, Area area, GuiContext context) {
        if (line.width() <= this.maxWidth) {
            drawMeasuredLines(graphics, Collections.singletonList(line));
            return;
        }
        ...
        context.graphicsPose().pushMatrix();
        context.graphicsPose().translate(-scroll, 0);
        drawMeasuredLines(graphics, Collections.singletonList(line));
        context.graphicsPose().popMatrix();
