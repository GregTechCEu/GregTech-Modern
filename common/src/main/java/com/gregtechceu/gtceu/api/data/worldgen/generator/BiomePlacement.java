...
public class BiomePlacement extends PlacementModifier {
    public static final PlacementModifierType<BiomePlacement> BIOME_PLACEMENT = GTRegistries.register(Registry.PLACEMENT_MODIFIERS, GTCEu.id("biome_placement"), () -> BiomePlacement.CODEC);
