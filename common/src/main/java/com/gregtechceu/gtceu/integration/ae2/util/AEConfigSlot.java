...
public class AEConfigSlot extends Widget implements IGhostIngredientTarget {
    ...
    public void drawInForeground(@NotNull PoseStack graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (slot.getConfig() == null && mouseOverConfig(mouseX, mouseY)) {
            ...
            DrawerHelper.drawTooltip(graphics, mouseX, mouseY, hoverStringList, ItemStack.EMPTY, null, Minecraft.getInstance().font);
        }
    }
    ...
    public static void drawSelectionOverlay(PoseStack graphics, int x, int y, int width, int height) {
