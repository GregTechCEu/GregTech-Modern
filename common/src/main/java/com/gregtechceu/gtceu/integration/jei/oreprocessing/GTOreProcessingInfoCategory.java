...
public class GTOreProcessingInfoCategory extends ModularUIRecipeCategory<GTOreProcessingInfoWrapper> {
    public final static RecipeType<GTOreProcessingInfoWrapper> RECIPE_TYPE = new RecipeType<>(new ResourceLocation(GTCEu.MOD_ID + ":ore_processing_diagram"), GTOreProcessingInfoWrapper.class);
