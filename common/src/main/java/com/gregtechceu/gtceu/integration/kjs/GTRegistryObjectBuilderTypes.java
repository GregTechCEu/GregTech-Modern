...
public class GTRegistryObjectBuilderTypes<K, V> {
    ...
    public record BuilderType<T>(String type, Class<? extends BuilderBase<? extends T>> builderClass, GTRegistryObjectBuilderTypes.BuilderFactory<T> factory) {
    }
    ...
    public final Map<String, GTRegistryObjectBuilderTypes.BuilderType<V>> types;
    public final Map<ResourceLocation, BuilderBase<? extends V>> objects;
    private GTRegistryObjectBuilderTypes.BuilderType<V> defaultType;
    ...
    public void addType(String type, Class<? extends BuilderBase<? extends V>> builderType, GTRegistryObjectBuilderTypes.BuilderFactory<V> factory, boolean isDefault) {
        var b = new GTRegistryObjectBuilderTypes.BuilderType<>(type, builderType, factory);
        types.put(type, b);
    ...
    public GTRegistryObjectBuilderTypes.BuilderType<V> getDefaultType() {
        if (types.isEmpty()) {
            return null;
    ...
    static void registerFor(GTRegistry<?, ?> registry) {
