...
public class FuelRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        SEMI_FLUID_GENERATOR_FUELS.recipeBuilder("creosote")
                .inputFluids(Creosote.getFluid(16))
                .duration(1)
                .EUt(V[LV])
                .save(provider);

        SEMI_FLUID_GENERATOR_FUELS.recipeBuilder("biomass")
                .inputFluids(Biomass.getFluid(4))
                .duration(1)
                .EUt(V[LV])
                .save(provider);
        ...
        SEMI_FLUID_GENERATOR_FUELS.recipeBuilder("heavy_oil")
                .inputFluids(OilHeavy.getFluid(16))
                .duration(5)
                .EUt(V[LV])
                .save(provider);

        SEMI_FLUID_GENERATOR_FUELS.recipeBuilder("sulfuric_heavy_fuel")
                .inputFluids(SulfuricHeavyFuel.getFluid(16))
                .duration(5)
                .EUt(V[LV])
                .save(provider);

        SEMI_FLUID_GENERATOR_FUELS.recipeBuilder("heavy_fuel")
                .inputFluids(HeavyFuel.getFluid(8))
                .duration(15)
                .EUt(V[LV])
                .save(provider);

        SEMI_FLUID_GENERATOR_FUELS.recipeBuilder("fish_oil")
                .inputFluids(FishOil.getFluid(16))
                .duration(1)
                .EUt(V[LV])
                .save(provider);
