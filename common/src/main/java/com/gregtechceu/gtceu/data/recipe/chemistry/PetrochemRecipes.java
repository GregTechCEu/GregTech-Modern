...
public class PetrochemRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(Oil.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(OilLight.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(OilHeavy.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(RawOil.getName())
    ...
    private static void desulfurizationRecipes(Consumer<FinishedRecipe> provider) {
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(SulfuricHeavyFuel.getName() + "_" + Hydrogen.getName())
                ...
                .duration(160).EUt(GTValues.VA[GTValues.LV]).save(provider);

        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(SulfuricLightFuel.getName() + "_" + Hydrogen.getName())
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(SulfuricNaphtha.getName() + "_" + Hydrogen.getName())
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(SulfuricGas.getName() + "_" + Hydrogen.getName())
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(NaturalGas.getName() + "_" + Hydrogen.getName())
    ...
    private static void distillationRecipes(Consumer<FinishedRecipe> provider) {
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(RefineryGas.getName())
                ...
                .duration(240).EUt(GTValues.VA[GTValues.MV]), provider);

        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(HydroCrackedEthane.getName())
                .inputFluids(HydroCrackedEthane.getFluid(1000))
                .outputFluids(Methane.getFluid(2000))
                .outputFluids(Hydrogen.getFluid(2000))
                .duration(120).EUt(GTValues.VA[GTValues.MV]), provider);

        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SteamCrackedEthane.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(HydroCrackedEthylene.getName())
                .inputFluids(HydroCrackedEthylene.getFluid(1000))
                .outputFluids(Ethane.getFluid(1000))
                .duration(120).EUt(GTValues.VA[GTValues.MV]), provider);

        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SteamCrackedEthylene.getName())
                .inputFluids(SteamCrackedEthylene.getFluid(1000))
                .outputItems(dust, Carbon)
                .outputFluids(Methane.getFluid(1000))
                .duration(120).EUt(GTValues.VA[GTValues.MV]), provider);

        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(HydroCrackedPropene.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SteamCrackedPropene.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(HydroCrackedPropane.getName())
                .inputFluids(HydroCrackedPropane.getFluid(1000))
                .outputFluids(Ethane.getFluid(1000))
                .outputFluids(Methane.getFluid(1000))
                .duration(120).EUt(GTValues.VA[GTValues.MV]), provider);

        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SteamCrackedPropane.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(HydroCrackedButane.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SteamCrackedButane.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(HydroCrackedButene.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SteamCrackedButene.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(HydroCrackedButadiene.getName())
                .inputFluids(HydroCrackedButadiene.getFluid(1000))
                .outputFluids(Butene.getFluid(750))
                .outputFluids(Ethylene.getFluid(500))
                .duration(120).EUt(GTValues.VA[GTValues.MV]), provider);

        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SteamCrackedButadiene.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlyHydroCrackedHeavyFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelyHydroCrackedHeavyFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlySteamCrackedHeavyFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelySteamCrackedHeavyFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlyHydroCrackedLightFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelyHydroCrackedLightFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlySteamCrackedLightFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelySteamCrackedLightFuel.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlyHydroCrackedNaphtha.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelyHydroCrackedNaphtha.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlySteamCrackedNaphtha.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelySteamCrackedNaphtha.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlyHydroCrackedGas.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelyHydroCrackedGas.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(LightlySteamCrackedGas.getName())
        ...
        DistillationRecipes.genDistilleryRecipes(GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder(SeverelySteamCrackedGas.getName())
    ...
    private static void distilleryRecipes(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.DISTILLERY_RECIPES.recipeBuilder(Toluene.getName())
                .circuitMeta(1)
                .inputFluids(Toluene.getFluid(30))
                .outputFluids(LightFuel.getFluid(30))
                .duration(160).EUt(24).save(provider);

        GTRecipeTypes.DISTILLERY_RECIPES.recipeBuilder(HeavyFuel.getName() + ".0")
                .circuitMeta(1)
                .inputFluids(HeavyFuel.getFluid(10))
                .outputFluids(Toluene.getFluid(4))
                .duration(16).EUt(24).save(provider);

        GTRecipeTypes.DISTILLERY_RECIPES.recipeBuilder(HeavyFuel.getName() + ".1")
                .circuitMeta(2)
                .inputFluids(HeavyFuel.getFluid(10))
                .outputFluids(Benzene.getFluid(4))
                .duration(16).EUt(24).save(provider);

        GTRecipeTypes.DISTILLERY_RECIPES.recipeBuilder(HeavyFuel.getName() + ".2")
                .circuitMeta(3)
    ...
    private static void lightlyCrack(Material raw, Material hydroCracked, Material steamCracked, Consumer<FinishedRecipe> provider) {
        ...
        GTRecipeTypes.CRACKING_RECIPES.recipeBuilder(id + 0)
                .circuitMeta(1)
                .inputFluids(raw.getFluid(1000))
                .inputFluids(Hydrogen.getFluid(2000))
                .outputFluids(hydroCracked.getFluid(1000))
                .duration(80).EUt(GTValues.VA[GTValues.MV]).save(provider);

        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(id + 1)
                .circuitMeta(1)
        ...
        GTRecipeTypes.CRACKING_RECIPES.recipeBuilder(id + 2)
                .circuitMeta(1)
                .inputFluids(raw.getFluid(1000))
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(id + 3)
                .circuitMeta(1)
                .inputFluids(raw.getFluid(1000))
                .inputFluids(Steam.getFluid(1000))
                .outputFluids(steamCracked.getFluid(500))
                .duration(160).duration(GTValues.VA[GTValues.LV]).save(provider);
    }
    ...
    private static void moderatelyCrack(Material raw, Material hydroCracked, Material steamCracked, Consumer<FinishedRecipe> provider) {
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(id + 1)
                ...
                .inputFluids(Hydrogen.getFluid(2000))
                .outputFluids(hydroCracked.getFluid(250))
                .duration(60).EUt(GTValues.VA[GTValues.LV]).save(provider);
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(id + 3)
                ...
                .inputFluids(Steam.getFluid(1000))
                .outputFluids(steamCracked.getFluid(500))
                .duration(240).EUt(GTValues.VA[GTValues.LV]).save(provider);
    }
