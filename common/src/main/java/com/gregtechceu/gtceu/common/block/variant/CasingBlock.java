...
public class CasingBlock extends VariantBlock<CasingBlock.CasingType> {
    ...
    public enum CasingType implements AppendableStringRepresentable {
        BRONZE_BRICKS("bronze_bricks", GTCEu.id("block/casings/solid/machine_bronze_plated_bricks"), false),
        PRIMITIVE_BRICKS("primitive_bricks", GTCEu.id("block/casings/solid/machine_primitive_bricks"), false),
        ...
        STEEL_TURBINE_CASING("steel_turbine",  GTCEu.id("block/casings/mechanic/machine_casing_turbine_steel")),
        TITANIUM_TURBINE_CASING("titanium_turbine",  GTCEu.id("block/casings/mechanic/machine_casing_turbine_titanium")),
        STAINLESS_TURBINE_CASING("stainless_turbine",  GTCEu.id("block/casings/mechanic/machine_casing_turbine_stainless_steel")),
        TUNGSTENSTEEL_TURBINE_CASING("tungstensteel_turbine",  GTCEu.id("block/casings/mechanic/machine_casing_turbine_tungstensteel")),
        ...
        private final boolean langAppendage;

        CasingType(String name, ResourceLocation texture) {
            this(name,texture,true);
        }

        CasingType(String name, ResourceLocation texture, boolean langAppendage) {
            this.name = name;
            this.texture = texture;
            this.langAppendage = langAppendage;
        }
        ...
        @Nonnull
        @Override
        public boolean hasLangAppendage() {
            return this.langAppendage;
        }
    }
}
