...
public class HigherDegreeMaterials {
    ...
    public static void register() {
        ...
        RedSteel = new Material.Builder("red_steel")
                ...
                .appendFlags(EXT_METAL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        BlueSteel = new Material.Builder("blue_steel")
                ...
                .appendFlags(EXT_METAL, GENERATE_FRAME, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        HSSG = new Material.Builder("hssg")
                ...
                .appendFlags(EXT2_METAL, GENERATE_SMALL_GEAR, GENERATE_FRAME, GENERATE_SPRING, GENERATE_FINE_WIRE, GENERATE_FOIL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        RedAlloy = new Material.Builder("red_alloy")
                .ingot(0).fluid()
                .color(0xC80000)
                .appendFlags(STD_METAL, GENERATE_FINE_WIRE, GENERATE_BOLT_SCREW, DISABLE_DECOMPOSITION, BLAST_ALLOY_CRAFTABLE)
        ...
        HSSE = new Material.Builder("hsse")
                ...
                .appendFlags(EXT2_METAL, GENERATE_FRAME, GENERATE_RING, BLAST_ALLOY_CRAFTABLE)
        ...
        HSSS = new Material.Builder("hsss")
                ...
                .appendFlags(EXT2_METAL, GENERATE_SMALL_GEAR, GENERATE_RING, GENERATE_FRAME, GENERATE_ROTOR, GENERATE_ROUND, GENERATE_FOIL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
