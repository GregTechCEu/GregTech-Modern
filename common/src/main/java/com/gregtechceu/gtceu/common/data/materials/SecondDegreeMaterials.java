...
public class SecondDegreeMaterials {
    ...
    public static void register() {
        ...
        BlackSteel = new Material.Builder("black_steel")
                ...
                .appendFlags(EXT_METAL, GENERATE_FINE_WIRE, GENERATE_GEAR, GENERATE_FRAME, BLAST_ALLOY_CRAFTABLE)
        ...
        TungstenSteel = new Material.Builder("tungsten_steel")
                ...
                .appendFlags(EXT2_METAL, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_DENSE, GENERATE_FRAME, GENERATE_SPRING, GENERATE_FOIL, GENERATE_FINE_WIRE, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        VanadiumSteel = new Material.Builder("vanadium_steel")
                ...
                .appendFlags(EXT2_METAL, GENERATE_FOIL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        NaquadahAlloy = new Material.Builder("naquadah_alloy")
                ...
                .appendFlags(EXT2_METAL, GENERATE_SPRING, GENERATE_RING, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_FRAME, GENERATE_DENSE, GENERATE_FOIL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
