...
public class GTOres {
    ...
    public static final GTOreDefinition BAUXITE_VEIN_END =
            create("bauxite_vein_end", 30, 0.3f, 40, WorldGenLayers.ENDSTONE, end(), HeightRangePlacement.uniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(80)))
    ...
    public static final GTOreDefinition MAGNETITE_VEIN_END =
            create("magnetite_vein_end", 35, 0.15f, 30, WorldGenLayers.ENDSTONE, end(), HeightRangePlacement.uniform(VerticalAnchor.absolute(20), VerticalAnchor.absolute(80)))
                    .biomes(BiomeTags.IS_END)
                    .layeredVeinGenerator()
                    .withLayerPattern(() -> GTLayerPattern.builder(END_RULES)
    ...
    public static final GTOreDefinition NAQUADAH_VEIN =
            create("naquadah_vein", 35, 1.0f, 30, WorldGenLayers.ENDSTONE, end(), HeightRangePlacement.uniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(90)))
                    .biomes(BiomeTags.IS_END)
                    .veinedVeinGenerator()
    ...
    public static final GTOreDefinition PITCHBLENDE_VEIN =
            create("pitchblende_vein_end", 25, 1.0f, 30, WorldGenLayers.ENDSTONE, end(), HeightRangePlacement.uniform(VerticalAnchor.absolute(30), VerticalAnchor.absolute(60)))
                    .biomes(BiomeTags.IS_END)
                    .veinedVeinGenerator()
    ...
    public static final GTOreDefinition BANDED_IRON_VEIN =
            create("banded_iron_vein", 30, 1.0f, 30, WorldGenLayers.NETHERRACK, nether(), HeightRangePlacement.uniform(VerticalAnchor.absolute(20), VerticalAnchor.absolute(40)))
    ...
    public static final GTOreDefinition TETRAHEDRITE_VEIN =
            create("tetrahedrite_vein", 30, 1.0f, 70, WorldGenLayers.NETHERRACK, nether(), HeightRangePlacement.uniform(VerticalAnchor.absolute(80), VerticalAnchor.absolute(120)))
                    .biomes(BiomeTags.IS_NETHER)
                    .veinedVeinGenerator()
    ...
    public static final GTOreDefinition CASSITERITE_VEIN =
            create("cassiterite_vein", 30, 1.0f, 80, WorldGenLayers.STONE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(80)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .veinedVeinGenerator()
    ...
    public static final GTOreDefinition COPPER_TIN_VEIN =
            create("copper_tin_vein", 30, 1.0f, 50, WorldGenLayers.STONE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-10), VerticalAnchor.absolute(160)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .veinedVeinGenerator()
    ...
    public static final GTOreDefinition GARNET_VEIN =
            create("garnet_vein", 25, 0.25f, 40, WorldGenLayers.STONE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-10), VerticalAnchor.absolute(50)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .dikeVeinGenerator()
    ...
    public static final GTOreDefinition IRON_VEIN =
            create("iron_vein", 30, 1.0f, 120, WorldGenLayers.STONE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-10), VerticalAnchor.absolute(60)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .veinedVeinGenerator()
    ...
    public static final GTOreDefinition COPPER_VEIN =
            create("copper_vein", 30, 1.0f, 80, WorldGenLayers.DEEPSLATE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-40), VerticalAnchor.absolute(10)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .veinedVeinGenerator()
                    .oreBlock(new VeinBlockDefinition(Chalcopyrite, 5))
    ...
    public static final GTOreDefinition LAPIS_VEIN =
            create("lapis_vein", 25, 0.25f, 40, WorldGenLayers.DEEPSLATE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-60), VerticalAnchor.absolute(10)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .dikeVeinGenerator()
    ...
    public static final GTOreDefinition MANGANESE_VEIN_OW =
            create("manganese_vein_ow", 25, 0.25f, 20, WorldGenLayers.DEEPSLATE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-30), VerticalAnchor.absolute(0)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .dikeVeinGenerator()
                    .withBlock(new DikeBlockDefinition(Grossular, 3, 20, 30))
    ...
    public static final GTOreDefinition REDSTONE_VEIN_OW =
            create("redstone_vein_ow", 30, 0.2f, 60, WorldGenLayers.DEEPSLATE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-65), VerticalAnchor.absolute(-10)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .layeredVeinGenerator()
                    .withLayerPattern(() -> GTLayerPattern.builder(OVERWORLD_RULES)
                            .layer(l -> l.weight(3).mat(Redstone).size(2, 4))
    ...
    public static final GTOreDefinition SAPPHIRE_VEIN =
            create("sapphire_vein", 25, 0.25f, 60, WorldGenLayers.DEEPSLATE, overworld(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-40), VerticalAnchor.absolute(0)))
                    .biomes(BiomeTags.IS_OVERWORLD)
                    .layeredVeinGenerator()
                    .withLayerPattern(() -> GTLayerPattern.builder(OVERWORLD_RULES)
                            // .layer(l -> l.weight(2).state(Blocks.STONE::defaultBlockState))
