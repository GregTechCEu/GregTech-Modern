...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        BatteryAlloy = new Material.Builder("battery_alloy")
                .ingot(1).fluid()
                .color(0x9C7CA0)
                .appendFlags(EXT_METAL, BLAST_ALLOY_CRAFTABLE)
        ...
        Brass = new Material.Builder("brass")
                ...
                .appendFlags(EXT2_METAL, MORTAR_GRINDABLE, BLAST_ALLOY_CRAFTABLE)
        ...
        Bronze = new Material.Builder("bronze")
                ...
                .appendFlags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_FRAME, GENERATE_SMALL_GEAR, GENERATE_FOIL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        Cupronickel = new Material.Builder("cupronickel")
                ...
                .appendFlags(EXT_METAL, GENERATE_SPRING, GENERATE_FINE_WIRE, BLAST_ALLOY_CRAFTABLE)
        ...
        Electrum = new Material.Builder("electrum")
                ...
                .appendFlags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_FINE_WIRE, GENERATE_RING, BLAST_ALLOY_CRAFTABLE)
        ...
        Invar = new Material.Builder("invar")
                ...
                .appendFlags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_FRAME, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        Kanthal = new Material.Builder("kanthal")
                ...
                .appendFlags(EXT_METAL, GENERATE_SPRING, BLAST_ALLOY_CRAFTABLE)
        ...
        Magnalium = new Material.Builder("magnalium")
                .ingot().fluid()
                .color(0xC8BEFF)
                .appendFlags(EXT2_METAL, BLAST_ALLOY_CRAFTABLE)
        ...
        NiobiumNitride = new Material.Builder("niobium_nitride")
                .ingot().fluid()
                .color(0x1D291D)
                .appendFlags(EXT_METAL, GENERATE_FOIL, BLAST_ALLOY_CRAFTABLE)
        ...
        NiobiumTitanium = new Material.Builder("niobium_titanium")
                .ingot().fluid()
                .color(0x1D1D29)
                .appendFlags(EXT2_METAL, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FOIL, GENERATE_FINE_WIRE, BLAST_ALLOY_CRAFTABLE)
        ...
        RoseGold = new Material.Builder("rose_gold")
                ...
                .appendFlags(EXT2_METAL, GENERATE_RING, BLAST_ALLOY_CRAFTABLE)
        ...
        BlackBronze = new Material.Builder("black_bronze")
                .ingot().fluid()
                .color(0x64327D)
                .appendFlags(EXT2_METAL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        StainlessSteel = new Material.Builder("stainless_steel")
                ...
                .appendFlags(EXT2_METAL, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_FRAME, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        Steel = new Material.Builder("steel")
                ...
                .appendFlags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_SPRING,
                        GENERATE_SPRING_SMALL, GENERATE_FRAME, DISABLE_DECOMPOSITION, GENERATE_FINE_WIRE, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
                .components(Iron, 1)
        ...
        VanadiumGallium = new Material.Builder("vanadium_gallium")
                ...
                .appendFlags(STD_METAL, GENERATE_FOIL, GENERATE_SPRING, GENERATE_SPRING_SMALL, BLAST_ALLOY_CRAFTABLE)
        ...
        WroughtIron = new Material.Builder("wrought_iron")
                ...
                .appendFlags(EXT_METAL, GENERATE_GEAR, GENERATE_FOIL, MORTAR_GRINDABLE, GENERATE_RING, GENERATE_LONG_ROD, GENERATE_BOLT_SCREW, DISABLE_DECOMPOSITION, BLAST_FURNACE_CALCITE_TRIPLE, BLAST_ALLOY_CRAFTABLE)
                .components(Iron, 1)
        ...
        YttriumBariumCuprate = new Material.Builder("yttrium_barium_cuprate")
                ...
                .appendFlags(EXT_METAL, GENERATE_FINE_WIRE, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FOIL, GENERATE_BOLT_SCREW, BLAST_ALLOY_CRAFTABLE)
        ...
        Osmiridium = new Material.Builder("osmiridium")
                ...
                .appendFlags(EXT2_METAL, GENERATE_SMALL_GEAR, GENERATE_RING, GENERATE_ROTOR, GENERATE_ROUND, GENERATE_FINE_WIRE, GENERATE_GEAR, BLAST_ALLOY_CRAFTABLE)
        ...
        IndiumGalliumPhosphide = new Material.Builder("indium_gallium_phosphide")
                .ingot(1).fluid()
                .color(0xA08CBE)
                .appendFlags(STD_METAL, DECOMPOSITION_BY_CENTRIFUGING, BLAST_ALLOY_CRAFTABLE)
        ...
        NickelZincFerrite = new Material.Builder("nickel_zinc_ferrite")
                ...
                .flags(GENERATE_RING, BLAST_ALLOY_CRAFTABLE)
        ...
        TungstenCarbide = new Material.Builder("tungsten_carbide")
                ...
                .appendFlags(EXT2_METAL, GENERATE_FOIL, GENERATE_GEAR, GENERATE_FRAME, DECOMPOSITION_BY_CENTRIFUGING)
        ...
        UraniumTriplatinum = new Material.Builder("uranium_triplatinum")
                ...
                .flags(DECOMPOSITION_BY_CENTRIFUGING, BLAST_ALLOY_CRAFTABLE)
