...
public class PrimitiveWorkableMachine extends WorkableMultiblockMachine implements IMachineModifyDrops {
    ...
    protected NotifiableFluidTank createImportFluidHandler(Object... args) {
        return new NotifiableFluidTank(this, getRecipeType()[getActiveRecipeType()].getMaxInputs(FluidRecipeCapability.CAP), 32 * FluidHelper.getBucket(), IO.IN);
    }

    protected NotifiableFluidTank createExportFluidHandler(Object... args) {
        return new NotifiableFluidTank(this, getRecipeType()[getActiveRecipeType()].getMaxOutputs(FluidRecipeCapability.CAP), 32 * FluidHelper.getBucket(), IO.OUT);
    }
