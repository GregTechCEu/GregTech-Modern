...
public class PrimitiveWorkableMachine extends WorkableMultiblockMachine implements IMachineModifyDrops {
    ...
    protected NotifiableFluidTank createImportFluidHandler(Object... args) {
        return new NotifiableFluidTank(this, getActiveRecipeType().getMaxInputs(FluidRecipeCapability.CAP), 32 * FluidHelper.getBucket(), IO.IN);
    }

    protected NotifiableFluidTank createExportFluidHandler(Object... args) {
        return new NotifiableFluidTank(this, getActiveRecipeType().getMaxOutputs(FluidRecipeCapability.CAP), 32 * FluidHelper.getBucket(), IO.OUT);
    }
