...
public class CycleFluidStorage implements IFluidTransfer {
    ...
    public CycleFluidTank createTank(int tank) {
        return new CycleFluidTank(tank);
    }

    public class CycleFluidTank implements IFluidStorage {

        private final int tank;

        public CycleFluidTank(int tank) {
            this.tank = tank;
        }
        ...
        public FluidStack getFluid() {
            return CycleFluidStorage.this.getFluidInTank(tank);
        }

        @Override
        public void setFluid(FluidStack fluid) {
            CycleFluidStorage.this.setFluidInTank(tank, fluid);
        }

        @Override
        public long getCapacity() {
            return CycleFluidStorage.this.getTankCapacity(tank);
        }
