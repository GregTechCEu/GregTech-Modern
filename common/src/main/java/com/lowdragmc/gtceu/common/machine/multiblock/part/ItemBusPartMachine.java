...
import com.lowdragmc.gtceu.api.machine.multiblock.part.TieredIOPartMachine;
...
public class ItemBusPartMachine extends TieredIOPartMachine implements IMachineModifyDrops, IUIMachine {
    ...
    public ItemBusPartMachine(IMetaMachineBlockEntity holder, int tier, IO io, Object... args) {
