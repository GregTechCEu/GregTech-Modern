...
import com.lowdragmc.gtceu.api.tag.TagUtil;
...
public class SeparationRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        // Centrifuge
        CENTRIFUGE_RECIPES.recipeBuilder(RefineryGas.getName())
        ...
        CENTRIFUGE_RECIPES.recipeBuilder(Butane.getName())
                .inputFluids(Butane.getFluid(320))
                .outputFluids(LPG.getFluid(370))
                .duration(20).EUt(5).save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Propane.getName())
                .inputFluids(Propane.getFluid(320))
                .outputFluids(LPG.getFluid(290))
                .duration(20).EUt(5).save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(NitrationMixture.getName())
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dust_%s".formatted(ReinforcedEpoxyResin.getName()))
                .inputItems(dust, ReinforcedEpoxyResin)
                .outputItems(dust, Epoxy)
                .duration(24).EUt(5).save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("ore_%s".formatted(Oilsands.getName()))
                .inputItems(TagPrefix.ore, Oilsands)
                .chancedOutput(new ItemStack(Blocks.SAND), 5000, 5000)
                .outputFluids(Oil.getFluid(500))
                .duration(200).EUt(5).save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Items.NETHER_WART.getDescriptionId()).duration(144).EUt(5)
                .inputItems(Ingredient.of(Items.NETHER_WART))
                .outputFluids(Methane.getFluid(18))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Blocks.BROWN_MUSHROOM.getDescriptionId()).duration(144).EUt(5)
                .inputItems(Ingredient.of(Blocks.BROWN_MUSHROOM))
                .outputFluids(Methane.getFluid(18))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Blocks.RED_MUSHROOM.getDescriptionId()).duration(144).EUt(5)
                .inputItems(Ingredient.of(Blocks.RED_MUSHROOM))
                .outputFluids(Methane.getFluid(18))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Items.MAGMA_CREAM.getDescriptionId()).duration(500).EUt(5)
        ...
        for (Item item : Registry.ITEM) {
            if (item.getFoodProperties() != null) {
                ...
                if (healAmount > 0) {
                    ...
                    CENTRIFUGE_RECIPES.recipeBuilder("food_" + item.getDescriptionId()).duration(144).EUt(5)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder(STICKY_RESIN.get().getDescriptionId()).duration(400).EUt(5)
...
//                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dirt").duration(250).EUt(VA[LV])
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("grass").duration(250).EUt(VA[LV])
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("mycelium").duration(650).EUt(VA[LV])
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dust_ash").duration(240).EUt(VA[LV])
                .inputItems(dust, Ash)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dust_netherrack").duration(160).EUt(20)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("soul_sand").duration(200).EUt(80)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("lava").duration(80).EUt(80)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dust_rare_earch").duration(64).EUt(20)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("sand_block").duration(50).EUt(VA[LV])
        ...
        CENTRIFUGE_RECIPES.recipeBuilder(Hydrogen.getName()).duration(160).EUt(20)
                .inputFluids(Hydrogen.getFluid(160))
                .outputFluids(Deuterium.getFluid(40))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Deuterium.getName()).duration(160).EUt(80)
                .inputFluids(Deuterium.getFluid(160))
                .outputFluids(Tritium.getFluid(40))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Helium.getName()).duration(160).EUt(80)
                .inputFluids(Helium.getFluid(80))
                .outputFluids(Helium3.getFluid(5))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(Air.getName()).duration(1600).EUt(VA[ULV])
                .inputFluids(Air.getFluid(10000))
                .outputFluids(Nitrogen.getFluid(3900))
                .outputFluids(Oxygen.getFluid(1000))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(NetherAir.getName()).duration(1600).EUt(VA[MV])
                .inputFluids(NetherAir.getFluid(10000))
                .outputFluids(CarbonMonoxide.getFluid(3900))
                .outputFluids(SulfurDioxide.getFluid(1000))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(EnderAir.getName()).duration(1600).EUt(VA[HV])
        ...
        // Stone Dust
        CENTRIFUGE_RECIPES.recipeBuilder("dust_stone").duration(480).EUt(VA[MV])
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dust_meta_mixture").duration(1000).EUt(900)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dust_oil_sands").duration(200).EUt(5)
                .inputItems(dust, Oilsands)
                .outputFluids(Oil.getFluid(1000))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("dust_quartz_sand").duration(60).EUt(VA[LV])
                .inputItems(dust, QuartzSand, 2)
                .outputItems(dust, Quartzite)
                .chancedOutput(dust, CertusQuartz, 2000, 200)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("dust_red_alloy").duration(900).EUt(VA[LV])
                .inputItems(dust, RedAlloy)
                .outputItems(dust, Redstone, 4)
                .outputItems(dust, Copper)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("dust_blue_alloy").duration(1200).EUt(VA[LV])
                .inputItems(dust, BlueAlloy)
                .outputItems(dust, Electrotine, 4)
                .outputItems(dust, Silver)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("dust_electrotine").duration(800).EUt(VA[LV])
                .inputItems(dust, Electrotine, 8)
                .outputItems(dust, Redstone)
                .outputItems(dust, Electrum)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("salt_water").duration(51).EUt(VA[LV])
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_sphalerite")
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_bauxite")
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_zeolite")
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_bentonite")
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_tungstic_acid")
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_sodium_hydroxide")
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_sugar")
