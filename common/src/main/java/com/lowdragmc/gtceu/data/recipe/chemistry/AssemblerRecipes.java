...
import com.lowdragmc.gtceu.common.block.variant.ActiveCasingBlock;
...
import static com.lowdragmc.gtceu.common.libs.GTBlocks.*;
...
//                .save(provider);
        ...
        // Voltage Coils
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_ULV.getId()).duration(200).EUt(VA[ULV])
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_LV.getId()).duration(200).EUt(VA[LV])
                .inputItems(stick, IronMagnetic)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_MV.getId()).duration(200).EUt(VA[MV])
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_HV.getId()).duration(200).EUt(VA[HV])
                .inputItems(stick, SteelMagnetic)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_EV.getId()).duration(200).EUt(VA[EV])
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_IV.getId()).duration(200).EUt(VA[IV])
                .inputItems(stick, NeodymiumMagnetic)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_LuV.getId()).duration(200).EUt(VA[LuV])
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_ZPM.getId()).duration(200).EUt(VA[ZPM])
                .inputItems(stick, SamariumMagnetic)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(VOLTAGE_COIL_UV.getId()).duration(200).EUt(VA[UV])
                .inputItems(stick, SamariumMagnetic)
        ...
        // Neutron Reflector
        ASSEMBLER_RECIPES.recipeBuilder(NEUTRON_REFLECTOR.getId()).duration(4000).EUt(VA[MV])
