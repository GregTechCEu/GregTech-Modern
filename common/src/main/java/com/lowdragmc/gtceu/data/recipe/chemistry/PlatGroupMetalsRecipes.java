...
public class PlatGroupMetalsRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CHEMICAL_RECIPES.recipeBuilder("crushed_purified" + Chalcopyrite.getName()).duration(50).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("crushed_purified" + Chalcocite.getName()).duration(50).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("crushed_purified" + Bornite.getName()).duration(50).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("crushed_purified" + Tetrahedrite.getName()).duration(50).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("crushed_purified" + Pentlandite.getName()).duration(50).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("crushed_purified" + Cooperite.getName()).duration(50).EUt(VA[LV])
        ...
        //
        CENTRIFUGE_RECIPES.recipeBuilder("dust_" + PlatinumGroupSludge.getName()).duration(500).EUt(VA[HV])
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_" + PlatinumRaw.getName()).duration(100).EUt(VA[MV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("dust_" + PalladiumRaw.getName()).duration(200).EUt(VA[MV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("dust_" + InertMetalMixture.getName()).duration(450).EUt(VA[EV])
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("dust_" + RhodiumSulfate.getName()).duration(100).EUt(VA[MV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("dust_" + RutheniumTetroxide.getName()).duration(200).EUt(VA[MV])
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("dust_" + RarestMetalMixture.getName()).duration(400).EUt(VA[IV])
        ...
        DistillationRecipes.genDistilleryRecipes(DISTILLATION_RECIPES.recipeBuilder(AcidicOsmiumSolution.getName()).duration(400).EUt(VA[MV])
        ...
        CHEMICAL_RECIPES.recipeBuilder("dust_" + OsmiumTetroxide.getName()).duration(200).EUt(VA[LV])
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dust_" + IridiumMetalResidue.getName()).duration(200).EUt(VA[MV])
                .inputItems(dust, IridiumMetalResidue, 5)
                .outputItems(dust, IridiumChloride, 4)
                .outputItems(dust, PlatinumSludgeResidue)
                .save(provider);

        CHEMICAL_RECIPES.recipeBuilder("dust_" + IridiumChloride.getName()).duration(100).EUt(VA[LV])
