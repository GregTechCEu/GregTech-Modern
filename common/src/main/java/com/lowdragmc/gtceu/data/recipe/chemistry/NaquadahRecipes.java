...
public class NaquadahRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CHEMICAL_RECIPES.recipeBuilder("dust_" + Antimony.getName()).EUt(VA[ULV]).duration(60)
                .inputItems(dust, Antimony, 2)
                .inputFluids(Oxygen.getFluid(3000))
                .outputItems(dust, AntimonyTrioxide, 5)
                .save(provider);

        CHEMICAL_RECIPES.recipeBuilder("dust_" + AntimonyTrioxide.getName()).EUt(VA[LV]).duration(60)
        ...
        CHEMICAL_RECIPES.recipeBuilder("dust_" + AntimonyTrifluoride.getName()).EUt(VA[HV]).duration(300)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("dust_" + Naquadah.getName()).EUt(VA[LuV]).duration(600)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder(ImpureEnrichedNaquadahSolution.getName()).EUt(VA[EV]).duration(400)
        ...
        MIXER_RECIPES.recipeBuilder(AcidicEnrichedNaquadahSolution.getName()).EUt(VA[HV]).duration(100)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder(AcidicEnrichedNaquadahSolution.getName()).EUt(VA[HV]).duration(100)
        ...
        BLAST_RECIPES.recipeBuilder("dust_" + EnrichedNaquadahSulfate.getName()).EUt(VA[IV]).duration(500).blastFurnaceTemp(7000)
        ...
        DISTILLATION_RECIPES.recipeBuilder(EnrichedNaquadahWaste.getName()).EUt(VA[HV]).duration(300)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder(ImpureNaquadriaSolution.getName()).EUt(VA[EV]).duration(400)
        ...
        MIXER_RECIPES.recipeBuilder(AcidicNaquadriaSolution.getName()).EUt(VA[HV]).duration(100)
                .inputFluids(NaquadriaSolution.getFluid(1000))
                .inputFluids(SulfuricAcid.getFluid(2000))
                .outputFluids(AcidicNaquadriaSolution.getFluid(3000))
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder(AcidicNaquadriaSolution.getName()).EUt(VA[HV]).duration(100)
        ...
        BLAST_RECIPES.recipeBuilder("ingot_hot_" + Naquadria.getName()).EUt(VA[ZPM]).duration(600).blastFurnaceTemp(9000)
        ...
        DISTILLATION_RECIPES.recipeBuilder(NaquadriaWaste.getName()).EUt(VA[HV]).duration(300)
        ...
        BLAST_RECIPES.recipeBuilder("ingot_hot_" + Trinium.getName()).duration(750).EUt(VA[LuV]).blastFurnaceTemp(Trinium.getBlastTemperature())
        ...
        BLAST_RECIPES.recipeBuilder("ingot_hot_" + Titanium.getName()).EUt(VA[HV]).duration(900).blastFurnaceTemp(1941)
        ...
        // Indium Phosphide
        CHEMICAL_RECIPES.recipeBuilder("indium_phosphide").duration(30).EUt(VA[ULV])
