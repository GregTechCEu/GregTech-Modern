...
public class CircuitRecipes {
    ...
    private static void waferRecipes(Consumer<FinishedRecipe> provider) {
        ...
        // Wafer engraving
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(INTEGRATED_LOGIC_CIRCUIT_WAFER.getId() + ".0")).duration(900).EUt(VA[MV]).inputItems(SILICON_WAFER).notConsumable(craftingLens, Color.Red).outputItems(INTEGRATED_LOGIC_CIRCUIT_WAFER).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(INTEGRATED_LOGIC_CIRCUIT_WAFER.getId() + ".1")).duration(500).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Red).outputItems(INTEGRATED_LOGIC_CIRCUIT_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(INTEGRATED_LOGIC_CIRCUIT_WAFER.getId() + ".2")).duration(200).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Red).outputItems(INTEGRATED_LOGIC_CIRCUIT_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(INTEGRATED_LOGIC_CIRCUIT_WAFER.getId() + ".3")).duration(50).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Red).outputItems(INTEGRATED_LOGIC_CIRCUIT_WAFER, 16).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(RANDOM_ACCESS_MEMORY_WAFER.getId() + ".0")).duration(900).EUt(VA[MV]).inputItems(SILICON_WAFER).notConsumable(craftingLens, Color.Green).outputItems(RANDOM_ACCESS_MEMORY_WAFER).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(RANDOM_ACCESS_MEMORY_WAFER.getId() + ".1")).duration(500).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Green).outputItems(RANDOM_ACCESS_MEMORY_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(RANDOM_ACCESS_MEMORY_WAFER.getId() + ".2")).duration(200).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Green).outputItems(RANDOM_ACCESS_MEMORY_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(RANDOM_ACCESS_MEMORY_WAFER.getId() + ".3")).duration(50).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Green).outputItems(RANDOM_ACCESS_MEMORY_WAFER, 16).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(CENTRAL_PROCESSING_UNIT_WAFER.getId() + ".0")).duration(900).EUt(VA[MV]).inputItems(SILICON_WAFER).notConsumable(craftingLens, Color.LightBlue).outputItems(CENTRAL_PROCESSING_UNIT_WAFER).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(CENTRAL_PROCESSING_UNIT_WAFER.getId() + ".1")).duration(500).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.LightBlue).outputItems(CENTRAL_PROCESSING_UNIT_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(CENTRAL_PROCESSING_UNIT_WAFER.getId() + ".2")).duration(200).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.LightBlue).outputItems(CENTRAL_PROCESSING_UNIT_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(CENTRAL_PROCESSING_UNIT_WAFER.getId() + ".3")).duration(50).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.LightBlue).outputItems(CENTRAL_PROCESSING_UNIT_WAFER, 16).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".0")).duration(900).EUt(VA[MV]).inputItems(SILICON_WAFER).notConsumable(craftingLens, Color.Blue).outputItems(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".1")).duration(500).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Blue).outputItems(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".2")).duration(200).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Blue).outputItems(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".3")).duration(50).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Blue).outputItems(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER, 16).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".0")).duration(900).EUt(VA[MV]).inputItems(SILICON_WAFER).notConsumable(craftingLens, Color.Orange).outputItems(LOW_POWER_INTEGRATED_CIRCUIT_WAFER).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".1")).duration(500).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Orange).outputItems(LOW_POWER_INTEGRATED_CIRCUIT_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".2")).duration(200).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Orange).outputItems(LOW_POWER_INTEGRATED_CIRCUIT_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(LOW_POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".3")).duration(50).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Orange).outputItems(LOW_POWER_INTEGRATED_CIRCUIT_WAFER, 16).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(SIMPLE_SYSTEM_ON_CHIP_WAFER.getId() + ".0")).duration(900).EUt(VA[MV]).inputItems(SILICON_WAFER).notConsumable(craftingLens, Color.Cyan).outputItems(SIMPLE_SYSTEM_ON_CHIP_WAFER).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(SIMPLE_SYSTEM_ON_CHIP_WAFER.getId() + ".1")).duration(500).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Cyan).outputItems(SIMPLE_SYSTEM_ON_CHIP_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(SIMPLE_SYSTEM_ON_CHIP_WAFER.getId() + ".2")).duration(200).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Cyan).outputItems(SIMPLE_SYSTEM_ON_CHIP_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(SIMPLE_SYSTEM_ON_CHIP_WAFER.getId() + ".3")).duration(50).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Cyan).outputItems(SIMPLE_SYSTEM_ON_CHIP_WAFER, 16).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(NAND_MEMORY_CHIP_WAFER.getId() + ".0")).duration(900).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Gray).outputItems(NAND_MEMORY_CHIP_WAFER).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(NAND_MEMORY_CHIP_WAFER.getId() + ".1")).duration(500).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Gray).outputItems(NAND_MEMORY_CHIP_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(NAND_MEMORY_CHIP_WAFER.getId() + ".2")).duration(200).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Gray).outputItems(NAND_MEMORY_CHIP_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(NOR_MEMORY_CHIP_WAFER.getId() + ".0")).duration(900).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Pink).outputItems(NOR_MEMORY_CHIP_WAFER).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(NOR_MEMORY_CHIP_WAFER.getId() + ".1")).duration(500).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Pink).outputItems(NOR_MEMORY_CHIP_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(NOR_MEMORY_CHIP_WAFER.getId() + ".2")).duration(200).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Pink).outputItems(NOR_MEMORY_CHIP_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".0")).duration(900).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Brown).outputItems(POWER_INTEGRATED_CIRCUIT_WAFER).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".1")).duration(500).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Brown).outputItems(POWER_INTEGRATED_CIRCUIT_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(POWER_INTEGRATED_CIRCUIT_WAFER.getId() + ".2")).duration(200).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Brown).outputItems(POWER_INTEGRATED_CIRCUIT_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(SYSTEM_ON_CHIP_WAFER.getId() + ".0")).duration(900).EUt(VA[HV]).inputItems(GLOWSTONE_WAFER).notConsumable(craftingLens, Color.Yellow).outputItems(SYSTEM_ON_CHIP_WAFER).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(SYSTEM_ON_CHIP_WAFER.getId() + ".1")).duration(500).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Yellow).outputItems(SYSTEM_ON_CHIP_WAFER, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(SYSTEM_ON_CHIP_WAFER.getId() + ".2")).duration(200).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Yellow).outputItems(SYSTEM_ON_CHIP_WAFER, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);

        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(ADVANCED_SYSTEM_ON_CHIP_WAFER.getId() + ".0")).duration(900).EUt(VA[EV]).inputItems(NAQUADAH_WAFER).notConsumable(craftingLens, Color.Purple).outputItems(ADVANCED_SYSTEM_ON_CHIP_WAFER).cleanroom(CleanroomType.CLEANROOM).save(provider);
        LASER_ENGRAVER_RECIPES.recipeBuilder(new ResourceLocation(ADVANCED_SYSTEM_ON_CHIP_WAFER.getId() + ".1")).duration(500).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Purple).outputItems(ADVANCED_SYSTEM_ON_CHIP_WAFER, 2).cleanroom(CleanroomType.CLEANROOM).save(provider);

        // Can replace this with a Quantum Star/Eye Lens if desired
        LASER_ENGRAVER_RECIPES.recipeBuilder(HIGHLY_ADVANCED_SOC_WAFER.getId()).duration(900).EUt(VA[IV]).inputItems(NEUTRONIUM_WAFER).notConsumable(craftingLens, Color.Black).outputItems(HIGHLY_ADVANCED_SOC_WAFER).cleanroom(CleanroomType.CLEANROOM).save(provider);
        ...
        // Wafer cutting
        CUTTER_RECIPES.recipeBuilder(HIGHLY_ADVANCED_SOC.getId()).duration(900).EUt(VA[IV]).inputItems(HIGHLY_ADVANCED_SOC_WAFER).outputItems(HIGHLY_ADVANCED_SOC, 6).cleanroom(CleanroomType.CLEANROOM).save(provider);
        CUTTER_RECIPES.recipeBuilder(ADVANCED_SYSTEM_ON_CHIP.getId()).duration(900).EUt(VA[EV]).inputItems(ADVANCED_SYSTEM_ON_CHIP_WAFER).outputItems(ADVANCED_SYSTEM_ON_CHIP, 6).cleanroom(CleanroomType.CLEANROOM).save(provider);
        CUTTER_RECIPES.recipeBuilder(SYSTEM_ON_CHIP.getId()).duration(900).EUt(VA[HV]).inputItems(SYSTEM_ON_CHIP_WAFER).outputItems(SYSTEM_ON_CHIP, 6).cleanroom(CleanroomType.CLEANROOM).save(provider);
        ...
        CUTTER_RECIPES.recipeBuilder(QUBIT_CENTRAL_PROCESSING_UNIT.getId()).duration(900).EUt(VA[EV]).inputItems(QUBIT_CENTRAL_PROCESSING_UNIT_WAFER).outputItems(QUBIT_CENTRAL_PROCESSING_UNIT, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        CUTTER_RECIPES.recipeBuilder(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT.getId()).duration(900).EUt(VA[MV]).inputItems(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER).outputItems(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT, 6).save(provider);
        CUTTER_RECIPES.recipeBuilder(LOW_POWER_INTEGRATED_CIRCUIT.getId()).duration(900).EUt(VA[HV]).inputItems(LOW_POWER_INTEGRATED_CIRCUIT_WAFER).outputItems(LOW_POWER_INTEGRATED_CIRCUIT, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        CUTTER_RECIPES.recipeBuilder(POWER_INTEGRATED_CIRCUIT.getId()).duration(900).EUt(VA[EV]).inputItems(POWER_INTEGRATED_CIRCUIT_WAFER).outputItems(POWER_INTEGRATED_CIRCUIT, 4).cleanroom(CleanroomType.CLEANROOM).save(provider);
        CUTTER_RECIPES.recipeBuilder(HIGH_POWER_INTEGRATED_CIRCUIT.getId()).duration(900).EUt(VA[IV]).inputItems(HIGH_POWER_INTEGRATED_CIRCUIT_WAFER).outputItems(HIGH_POWER_INTEGRATED_CIRCUIT, 2).cleanroom(CleanroomType.CLEANROOM).save(provider);
        CUTTER_RECIPES.recipeBuilder(ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT.getId()).duration(900).EUt(VA[LuV]).inputItems(ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT_WAFER).outputItems(ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT, 2).cleanroom(CleanroomType.CLEANROOM).save(provider);
        ...
        CUTTER_RECIPES.recipeBuilder(CENTRAL_PROCESSING_UNIT.getId()).duration(900).EUt(VA[MV]).inputItems(CENTRAL_PROCESSING_UNIT_WAFER).outputItems(CENTRAL_PROCESSING_UNIT, 8).save(provider);
        ...
        CUTTER_RECIPES.recipeBuilder(NANO_CENTRAL_PROCESSING_UNIT.getId()).duration(900).EUt(VA[HV]).inputItems(NANO_CENTRAL_PROCESSING_UNIT_WAFER).outputItems(NANO_CENTRAL_PROCESSING_UNIT, 8).cleanroom(CleanroomType.CLEANROOM).save(provider);
    }
    ...
    private static void boardRecipes(Consumer<FinishedRecipe> provider) {
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(GOOD_CIRCUIT_BOARD.getId() + ".0")).EUt(VA[LV]).duration(300)
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(GOOD_CIRCUIT_BOARD.getId() + ".1")).EUt(VA[LV]).duration(300)
                .inputItems(foil, Silver, 4)
                .inputItems(PHENOLIC_BOARD)
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(PLASTIC_CIRCUIT_BOARD.getId() + ".0")).duration(600).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(PLASTIC_CIRCUIT_BOARD.getId() + ".1")).duration(600).EUt(VA[LV])
                .inputItems(PLASTIC_BOARD)
                .inputItems(foil, Copper, 6)
        ...
        // Epoxy Board
        CHEMICAL_RECIPES.recipeBuilder(EPOXY_BOARD.getId()).duration(600).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(ADVANCED_CIRCUIT_BOARD.getId() + ".0")).duration(900).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(ADVANCED_CIRCUIT_BOARD.getId() + ".1")).duration(900).EUt(VA[LV])
                .inputItems(EPOXY_BOARD)
                .inputItems(foil, Electrum, 8)
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(EXTREME_CIRCUIT_BOARD.getId() + ".0")).duration(1200).EUt(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(EXTREME_CIRCUIT_BOARD.getId() + ".1")).duration(1200).EUt(VA[LV])
                .inputItems(FIBER_BOARD)
                .inputItems(foil, AnnealedCopper, 12)
        ...
        CHEMICAL_RECIPES.recipeBuilder(MULTILAYER_FIBER_BOARD.getId()).duration(500).EUt(VA[HV])
        ...
        // Elite Circuit Board
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(ELITE_CIRCUIT_BOARD.getId() + ".0")).duration(1500).EUt(VA[MV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(ELITE_CIRCUIT_BOARD.getId() + ".1")).duration(1500).EUt(VA[MV])
                .inputItems(MULTILAYER_FIBER_BOARD)
                .inputItems(foil, Platinum, 8)
        ...
        FLUID_SOLIDFICATION_RECIPES.recipeBuilder(new ResourceLocation(PETRI_DISH.getId() + ".0")).duration(160).EUt(VA[HV])
                .notConsumable(SHAPE_MOLD_CYLINDER)
                .inputFluids(Polytetrafluoroethylene.getFluid(L / 4))
                .outputItems(PETRI_DISH)
                .save(provider);

        FLUID_SOLIDFICATION_RECIPES.recipeBuilder(new ResourceLocation(PETRI_DISH.getId() + ".1")).duration(40).EUt(VA[HV])
                .notConsumable(SHAPE_MOLD_CYLINDER)
                .inputFluids(Polybenzimidazole.getFluid(L / 8))
                .outputItems(PETRI_DISH, 2)
                .save(provider);

        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(WETWARE_BOARD.getId()).duration(1200).EUt(VA[LuV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(WETWARE_CIRCUIT_BOARD.getId() + ".0")).duration(1800).EUt(VA[HV])
        ...
        CHEMICAL_RECIPES.recipeBuilder(new ResourceLocation(WETWARE_CIRCUIT_BOARD.getId() + ".1")).duration(1800).EUt(VA[HV])
                .inputItems(WETWARE_BOARD)
                .inputItems(foil, NiobiumTitanium, 32)
    ...
    private static void circuitRecipes(Consumer<FinishedRecipe> provider) {
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(ELECTRONIC_CIRCUIT_MV.getId()).EUt(VA[LV]).duration(300)
        ...
        // HV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(INTEGRATED_CIRCUIT_HV.getId()).EUt(VA[LV]).duration(800)
        ...
        // NAND Chip ULV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(NAND_CHIP_ULV.getId() + ".0")).EUt(VA[MV]).duration(300)
                .inputItems(GOOD_CIRCUIT_BOARD)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(NAND_CHIP_ULV.getId() + ".1")).EUt(VA[MV]).duration(300)
        ...
        // HV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(PROCESSOR_ASSEMBLY_HV.getId()).EUt(VA[MV]).duration(400)
                .inputItems(PLASTIC_CIRCUIT_BOARD)
        ...
        // EV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(WORKSTATION_EV.getId()).EUt(VA[MV]).duration(400)
                .inputItems(PLASTIC_CIRCUIT_BOARD)
        ...
        // IV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(MAINFRAME_IV.getId() + ".0")).EUt(VA[HV]).duration(800)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(MAINFRAME_IV.getId() + ".1")).EUt(VA[HV]).duration(400)
                .inputItems(frameGt, Aluminium, 2)
                .inputItems(WORKSTATION_EV, 2)
        ...
        // LuV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(NANO_MAINFRAME_LUV.getId() + ".0")).EUt(VA[EV]).duration(800)
                .inputItems(frameGt, Aluminium, 2)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(NANO_MAINFRAME_LUV.getId() + ".1")).EUt(VA[EV]).duration(400)
                .inputItems(frameGt, Aluminium, 2)
                .inputItems(NANO_COMPUTER_IV, 2)
        ...
        // ZPM
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(QUANTUM_MAINFRAME_ZPM.getId() + ".0")).EUt(VA[IV]).duration(800)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder(new ResourceLocation(QUANTUM_MAINFRAME_ZPM.getId() + ".1")).EUt(VA[IV]).duration(400)
                .inputItems(frameGt, HSSG, 2)
                .inputItems(QUANTUM_COMPUTER_LUV, 2)
        ...
        // UV
        ASSEMBLY_LINE_RECIPES.recipeBuilder(CRYSTAL_MAINFRAME_UV.getId()).EUt(VA[LuV]).duration(800)
