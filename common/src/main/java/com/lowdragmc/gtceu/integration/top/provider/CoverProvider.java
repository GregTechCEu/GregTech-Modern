package com.lowdragmc.gtceu.integration.top.provider;
...
//    }
    ...
    @Override
    protected void addProbeInfo(ICoverable capability, IProbeInfo probeInfo, Player player, BlockEntity blockEntity, IProbeHitData data) {
