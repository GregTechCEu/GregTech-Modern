...
import com.lowdragmc.gtceu.api.data.chemical.material.properties.IMaterialProperty;
import com.lowdragmc.gtceu.api.data.chemical.material.properties.PropertyKey;
import com.lowdragmc.gtceu.api.data.chemical.material.stack.MaterialStack;
...
import static com.lowdragmc.gtceu.api.tag.TagPrefix.Conditions.*;
import static com.lowdragmc.gtceu.api.data.chemical.material.info.MaterialFlags.*;

import static com.lowdragmc.gtceu.api.GTValues.M;
...
public class TagPrefix {
    ...
    public static final TagPrefix plateDense = new TagPrefix("plateDense", "plates/dense")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_DENSE) && !mat.hasFlag(NO_SMASHING));
    ...
    public static final TagPrefix plateDouble = new TagPrefix("plateDouble", "plates/double")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(hasIngotProperty.and(mat -> mat.hasFlag(GENERATE_PLATE) && !mat.hasFlag(NO_SMASHING)));
    ...
    public static final TagPrefix plate = new TagPrefix("plate", "plates")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_PLATE));
    ...
    public static final TagPrefix round = new TagPrefix("round", "rounds")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_ROUND));
    ...
    public static final TagPrefix foil = new TagPrefix("foil", "foils")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_FOIL));
    ...
    public static final TagPrefix stickLong = new TagPrefix("stickLong", "sticks/long")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_LONG_ROD));
    ...
    public static final TagPrefix stick = new TagPrefix("stick", "sticks")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_ROD));
    ...
    public static final TagPrefix bolt = new TagPrefix("bolt", "bolts")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_BOLT_SCREW));
    ...
    public static final TagPrefix ring = new TagPrefix("ring", "rings")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_RING));
    ...
    public static final TagPrefix springSmall = new TagPrefix("springSmall", "springs/small")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_SPRING_SMALL) && !mat.hasFlag(NO_SMASHING));
    ...
    public static final TagPrefix spring = new TagPrefix("spring", "springs")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_SPRING) && !mat.hasFlag(NO_SMASHING));
    ...
    public static final TagPrefix wireFine = new TagPrefix("wireFine", "wires/fine")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_FINE_WIRE));
    ...
    public static final TagPrefix rotor = new TagPrefix("rotor", "rotors")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_ROTOR));
    ...
    public static final TagPrefix gearSmall = new TagPrefix("gearSmall", "gears/small")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_SMALL_GEAR));
    ...
    public static final TagPrefix gear = new TagPrefix("gear", "gears")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_GEAR));
    ...
    public static final TagPrefix lens = new TagPrefix("lens")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(mat -> mat.hasFlag(GENERATE_LENS));
    ...
    public static final TagPrefix toolHeadBuzzSaw = new TagPrefix("toolHeadBuzzSaw")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(hasNoCraftingToolProperty.and(mat -> mat.hasFlag(GENERATE_PLATE)));
    ...
    public static final TagPrefix toolHeadScrewdriver = new TagPrefix("toolHeadScrewdriver")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(hasNoCraftingToolProperty.and(mat -> mat.hasFlag(GENERATE_LONG_ROD)));
    ...
    public static final TagPrefix toolHeadDrill = new TagPrefix("toolHeadDrill")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(hasToolProperty.and(mat -> mat.hasFlag(GENERATE_PLATE)));
    ...
    public static final TagPrefix turbineBlade = new TagPrefix("turbineBlade")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(hasRotorProperty.and(m -> m.hasFlags(GENERATE_BOLT_SCREW, GENERATE_PLATE) && !m.hasProperty(PropertyKey.GEM)));
    ...
    public static final TagPrefix frameGt = new TagPrefix("frameGt", "frames")
            ...
            .unificationEnabled(true)
            .generationCondition(material -> material.hasFlag(GENERATE_FRAME));

    public static final TagPrefix pipeTinyFluid = new TagPrefix("pipeTinyFluid").materialAmount(M / 2).unificationEnabled(true);
    public static final TagPrefix pipeSmallFluid = new TagPrefix("pipeSmallFluid").materialAmount(M).unificationEnabled(true);
    public static final TagPrefix pipeNormalFluid = new TagPrefix("pipeNormalFluid").materialAmount(M * 3).unificationEnabled(true);
    public static final TagPrefix pipeLargeFluid = new TagPrefix("pipeLargeFluid").materialAmount(M * 6).unificationEnabled(true);
    public static final TagPrefix pipeHugeFluid = new TagPrefix("pipeHugeFluid").materialAmount(M * 12).unificationEnabled(true);
    public static final TagPrefix pipeQuadrupleFluid = new TagPrefix("pipeQuadrupleFluid").materialAmount(M * 4).unificationEnabled(true);
    public static final TagPrefix pipeNonupleFluid = new TagPrefix("pipeNonupleFluid").materialAmount(M * 9).unificationEnabled(true);

    public static final TagPrefix pipeTinyItem = new TagPrefix("pipeTinyItem").materialAmount(M / 2).unificationEnabled(true);
    public static final TagPrefix pipeSmallItem = new TagPrefix("pipeSmallItem").materialAmount(M).unificationEnabled(true);
    public static final TagPrefix pipeNormalItem = new TagPrefix("pipeNormalItem").materialAmount(M * 3).unificationEnabled(true);
    public static final TagPrefix pipeLargeItem = new TagPrefix("pipeLargeItem").materialAmount(M * 6).unificationEnabled(true);
    public static final TagPrefix pipeHugeItem = new TagPrefix("pipeHugeItem").materialAmount(M * 12).unificationEnabled(true);

    public static final TagPrefix pipeSmallRestrictive = new TagPrefix("pipeSmallRestrictive").materialAmount(M).unificationEnabled(true);
    public static final TagPrefix pipeNormalRestrictive = new TagPrefix("pipeNormalRestrictive").materialAmount(M * 3).unificationEnabled(true);
    public static final TagPrefix pipeLargeRestrictive = new TagPrefix("pipeLargeRestrictive").materialAmount(M * 6).unificationEnabled(true);
    public static final TagPrefix pipeHugeRestrictive = new TagPrefix("pipeHugeRestrictive").materialAmount(M * 12).unificationEnabled(true);

    public static final TagPrefix wireGtHex = new TagPrefix("wireGtHex").materialAmount(M * 8).unificationEnabled(true);
    public static final TagPrefix wireGtOctal = new TagPrefix("wireGtOctal").materialAmount(M * 4).unificationEnabled(true);
    public static final TagPrefix wireGtQuadruple = new TagPrefix("wireGtQuadruple").materialAmount(M * 2).unificationEnabled(true);
    public static final TagPrefix wireGtDouble = new TagPrefix("wireGtDouble").materialAmount(M).unificationEnabled(true);
    public static final TagPrefix wireGtSingle = new TagPrefix("wireGtSingle").materialAmount(M / 2).unificationEnabled(true);

    public static final TagPrefix cableGtHex = new TagPrefix("cableGtHex").materialAmount(M * 8).unificationEnabled(true);
    public static final TagPrefix cableGtOctal = new TagPrefix("cableGtOctal").materialAmount(M * 4).unificationEnabled(true);
    public static final TagPrefix cableGtQuadruple = new TagPrefix("cableGtQuadruple").materialAmount(M * 2).unificationEnabled(true);
    public static final TagPrefix cableGtDouble = new TagPrefix("cableGtDouble").materialAmount(M).unificationEnabled(true);
    public static final TagPrefix cableGtSingle = new TagPrefix("cableGtSingle").materialAmount(M / 2).unificationEnabled(true);

    // Special Prefix used mainly for the Crafting Handler.
    public static final TagPrefix craftingLens = new TagPrefix("craftingLens").isMarkerPrefix(true);;
    ...
    public String getLocalNameForItem(Material material) {
        ...
        if (LocalizationUtils.exist(specifiedUnlocalized)) return LocalizationUtils.format(specifiedUnlocalized);
        String unlocalized = findUnlocalizedName(material);
        String matLocalized = LocalizationUtils.format(material.getUnlocalizedName());
