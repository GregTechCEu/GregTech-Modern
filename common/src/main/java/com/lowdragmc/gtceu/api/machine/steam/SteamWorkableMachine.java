...
import com.lowdragmc.gtceu.api.machine.feature.ISteamVentMachine;
...
public abstract class SteamWorkableMachine extends SteamMachine implements IRecipeLogicMachine, ISteamVentMachine {
    ...
    public SteamWorkableMachine(IMetaMachineBlockEntity holder, boolean isHighPressure, Object... args) {
