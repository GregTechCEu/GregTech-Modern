...
import com.lowdragmc.gtceu.api.gui.widget.PredicatedButtonWidget;
import com.lowdragmc.gtceu.api.gui.widget.PredicatedImageWidget;
import com.lowdragmc.gtceu.api.gui.widget.ToggleButtonWidget;
import com.lowdragmc.gtceu.api.machine.feature.IAutoOutputBoth;
import com.lowdragmc.gtceu.api.machine.feature.IUIMachine;
import com.lowdragmc.gtceu.api.machine.trait.NotifiableItemStackHandler;
import com.lowdragmc.gtceu.common.item.IntCircuitBehaviour;
...
public class SimpleTieredMachine extends WorkableTieredMachine implements IAutoOutputBoth, IUIMachine {
    ...
    public ModularUI createUI(Player entityPlayer) {
        ...
        var modularUI = new ModularUI(176, 166 + yOffset, this, entityPlayer)
                ...
                .widget(new SlotWidget(chargerInventory, 0, 79, 62 + yOffset, true, true)
                        ...
                        .setHoverTooltips(Component.translatable("gtceu.gui.charger_slot.tooltip", GTValues.VNF[getTier()], GTValues.VNF[getTier()])))
    ...
    protected SlotWidget getCircuitSlotTooltip(SlotWidget widget) {
        widget.setHoverTooltips("gtceu.gui.configurator_slot.tooltip");
        return widget;
    }
