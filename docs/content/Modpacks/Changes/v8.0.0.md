...
Marker materials have been removed. This means that a few utils related to colored items have been moved. All GT color values are now located in `GTValues.COLORS`, and getting a colored lens should now be done using the `forge:lens/<color>` tags.
## Other Changes
