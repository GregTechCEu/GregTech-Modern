...
## Reorganization of CustomTags
GT's custom tag keys have been grouped by type. All of the keys themselves still exist, but have moved from `com.gregtechceu.gtceu.data.recipe.CustomTags` to `com.gregtechceu.gtceu.data.tags.GTTags.<TagType>`. Some examples:
- `CustomTags.BUTCHERY_KNIVES` (item tag) -> `GTTags.Items.TOOLS_BUTCHERY_KNIVES`
- `CustomTags.CLEANROOM_DOORS` (block tag) -> `GTTags.Blocks.CLEANROOM_DOORS`
- `CustomTags.HPCA_COOLANTS` (fluid tag) -> `GTTags.Fluids.HPCA_COOLANTS`
- `CustomTags.HEAT_IMMUNE` (entity type tag) -> `GTTags.EntityTypes.HEAT_IMMUNE`
<!-- - `CustomTags.SPIDERS` (entity type tag) -> `EntityTypeTags.ARTHROPODS` -->
<!-- - `CustomTags.IRON_GOLEMS` (entity type tag) -> `GTTags.EntityTypes.CONSTRUCTS` -->
