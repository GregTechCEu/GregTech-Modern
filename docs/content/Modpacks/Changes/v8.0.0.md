...
These changes can be done with a simple find + replace:
- `com.gregtechceu.gtceu.api.data.damagesource` is now `com.gregtechceu.gtceu.api.datasource`
- `com.gregtechceu.gtceu.api.data.medicalcondition` is now `com.gregtechceu.gtceu.api.medicalcondition`
- `com.gregtechceu.gtceu.api.data.worldgen` is now `com.gregtechceu.gtceu.api.worldgen`
