...
Marker materials have been removed. This means that a few things related to colored items have been moved. All colors GT uses are now located in the vanilla `DyeColor` enum, and getting a colored lens should now be done using the `#gtceu:lens/<color>` tags.
