...
public class ExampleMod {
    ...
    public static final DeferredHolder<RecipeConditionType<?>, RecipeConditionType<ExampleCondition>> EXAMPLE_CONDITION = RECIPE_CONDITIONS.register("example_condition",
