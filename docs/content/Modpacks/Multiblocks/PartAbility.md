...
title: PartAbility
---
PartAbilities are a quick way of creating a MultiPredicate from a similar collection of blocks. Some examples are all EnergyHatches, every MufflerPart, all LaserHatches, etc.
