...
Each material can have different items (and blocks) registered, such as ingots, dusts, plates, wires, ores, etc. called [TagPrefixes](./TagPrefixes-and-the-power-of-.setIgnored().md)
