package com.gregtechceu.gtceu.core.compat;
...
public class GuiGraphics extends GuiGraphicsExtractor {
    ...
    public static GuiGraphics from(GuiGraphicsExtractor graphics, GuiRenderState renderState, int mouseX, int mouseY) {
        if (graphics instanceof GuiGraphics guiGraphics) {
            return guiGraphics;
        }
        return new GuiGraphics(Minecraft.getInstance(), renderState, mouseX, mouseY);
    }
