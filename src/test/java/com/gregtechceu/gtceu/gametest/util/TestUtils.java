...
public class TestUtils {
    ...
    // Returns true if the size is NOT an exact multiple of the total run count
    // Intended to test if an IntProvider is being rolled correctly for a batch, or if it is returning a single value
    // multiplied
    // This test can cause false failures from bad luck and should be run more than once to reduce the odds of bad luck
