...
public class OreRenderLayer extends MapRenderLayer {
    ...
    public static MutableComponent getName(GeneratedVeinMetadata vein) {
        ...
        if (vein == null || vein.definition() == null ||
            ...
            return Component.translatable("minimap.gtceu.ore_vein.depleted");
        }
        return Component.translatable("recipeviewer.gtceu.ore_vein." + GTOreVeinWidget.getOreName(vein.definition()));
    }
