...
public class AEFluidConfigSlot extends AEConfigSlot {
            ...
            if (button == 1) {
                ...
                if (fluid != null) {
                    writeClientAction(UPDATE_ID, buf -> {
                        buf.writeResourceLocation(Registry.FLUID.getKey(fluid.getFluid()));
    ...
    public void handleClientAction(int id, FriendlyByteBuf buffer) {
        ...
        if (id == UPDATE_ID) {
            FluidStack fluid = FluidStack.create(Registry.FLUID.get(buffer.readResourceLocation()), buffer.readVarLong());
