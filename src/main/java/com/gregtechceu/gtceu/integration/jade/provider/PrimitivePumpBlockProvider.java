...
public class PrimitivePumpBlockProvider extends MachineInfoProvider<PrimitivePumpMachine, LongTag> implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
