...
public class GTCreateDisplayTargets {
    ...
    public static final RegistryEntry<ComputerMonitorCoverDisplayTarget> COMPUTER_MONITOR_COVER = registerToAllMachines("computer_monitor_cover", ComputerMonitorCoverDisplayTarget::new);
