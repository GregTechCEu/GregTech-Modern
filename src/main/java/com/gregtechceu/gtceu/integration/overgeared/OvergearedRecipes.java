...
public class OvergearedRecipes {
    ...
    public static void generateRecipes(Consumer<FinishedRecipe> consumer, GTToolType tool, TagPrefix prefix, String... patterns) {
        for (Material material : GTCEuAPI.materialManager.getRegisteredMaterials()) {
            if (hasToolProperty.and(mat -> mat.hasFlag(MaterialFlags.GENERATE_PLATE))
                ...
                if (material.hasHotIngot()) {
                    ShapedForgingRecipeBuilder.shaped(RecipeCategory.MISC, ChemicalHelper.get(prefix, material).getItem(), 3)
                            .pattern(patterns[0])
                            .pattern(patterns[1])
                            .pattern(patterns[2])
                            ...
                            .unlockedBy(getHasName(ChemicalHelper.get(ingotHot, material).getItem()), has(ChemicalHelper.get(ingotHot, material).getItem()))
                            .save(consumer);
                    ...
                    ShapedForgingRecipeBuilder.shaped(RecipeCategory.MISC, ChemicalHelper.get(prefix, material).getItem(), 3)
                            ...
                            .setQuality(true)
                            .showNotification(true)
                            .unlockedBy(getHasName(ChemicalHelper.get(ingot, material).getItem()), has(ChemicalHelper.get(ingot, material).getItem()))
                            .save(consumer);
                } else if (material.hasProperty(PropertyKey.GEM)) {
                    ShapedForgingRecipeBuilder.shaped(RecipeCategory.MISC, ChemicalHelper.get(prefix, material).getItem(), 3)
                            .pattern(patterns[0])
                            ...
                            .setQuality(true)
                            .showNotification(true)
                            .unlockedBy(getHasName(ChemicalHelper.get(gem, material).getItem()), has(ChemicalHelper.get(gem, material).getItem()))
                            .save(consumer);
                }

                OvergearedShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ToolHelper.get(tool, material).getItem())
                        .requires(ChemicalHelper.get(prefix, material).getItem())
                        .requires(Tags.Items.RODS_WOODEN)
                        .unlockedBy(getHasName(ChemicalHelper.get(prefix, material).getItem()), has(ChemicalHelper.get(prefix, material).getItem()))
                        .save(consumer);
            }
        }
    }
