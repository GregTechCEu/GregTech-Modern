    ...
    private void setRecipeWidget() {
        ...
        for (RecipeCondition condition : recipe.conditions) {
            ...
            if (condition instanceof DimensionCondition dimCondition) {
                addWidget(new LabelWidget(3 - xOffset, yOffset += LINE_HEIGHT + 4, Component.translatable("recipe.condition.dimension_marker.tooltip")));
                addWidget(dimCondition.setupDimensionMarkers(53 - xOffset, yOffset - 4).setBackgroundTexture(IGuiTexture.EMPTY));
            }
