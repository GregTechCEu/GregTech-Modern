...
public interface GTRecipeSchema {
    ...
    class GTRecipeJS extends RecipeJS {
        ...
        public GTRecipeJS outputItems(OutputItem... outputs) {return output(ItemRecipeCapability.CAP, (Object[]) outputs);}
        ...
        public GTRecipeJS circuit(int configuration) {
            return notConsumableItem(InputItem.of(IntCircuitIngredient.circuitInput(configuration), 1));
        }
