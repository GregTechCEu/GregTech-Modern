...
public class EnergyStackComponent implements RecipeComponent<EnergyStack.WithIO> {
    ...
    // spotless:off
    public static final RecipeComponentType<EnergyStack.WithIO> ENERGY_STACK = RecipeComponentType.unit(ResourceLocation.fromIdentifier(GTCEu.id("energy_stack")), new EnergyStackComponent());
    // spotless:on
