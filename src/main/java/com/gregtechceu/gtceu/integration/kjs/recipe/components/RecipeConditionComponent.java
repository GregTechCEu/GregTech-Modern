...
public class RecipeConditionComponent implements RecipeComponent<RecipeCondition<?>> {
    ...
    // spotless:off
    public static final RecipeComponentType<RecipeCondition<?>> RECIPE_CONDITION = RecipeComponentType.unit(ResourceLocation.fromIdentifier(GTCEu.id("recipe_condition")), new RecipeConditionComponent());
    // spotless:on
