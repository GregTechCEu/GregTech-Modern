...
public class HPCAPartModel extends TieredHullMachineModel {
    ...
    public HPCAPartModel(boolean isAdvanced, ResourceLocation texture, ResourceLocation damagedTexture) {
        super(GTValues.ZPM,
    ...
    public HPCAPartModel(boolean isAdvanced,
