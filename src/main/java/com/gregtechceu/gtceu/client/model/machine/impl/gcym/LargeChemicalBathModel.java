package com.gregtechceu.gtceu.client.model.machine.impl.gcym;

import com.gregtechceu.gtceu.api.blockentity.MetaMachineBlockEntity;
import com.gregtechceu.gtceu.api.pattern.util.RelativeDirection;
import com.gregtechceu.gtceu.client.renderer.block.FluidBlockRenderer;
import com.gregtechceu.gtceu.client.model.machine.impl.WorkableCasingMachineModel;
...
public class LargeChemicalBathModel extends WorkableCasingMachineModel {

    private final FluidBlockRenderer fluidBlockRenderer;
    private Fluid cachedFluid;
    private ResourceLocation cachedRecipe;

    public LargeChemicalBathModel(ResourceLocation baseCasing, ResourceLocation workableModel) {
