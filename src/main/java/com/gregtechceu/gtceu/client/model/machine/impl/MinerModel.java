...
public class MinerModel extends WorkableTieredHullMachineModel {
    ...
    public MinerModel(int tier, ResourceLocation modelLocation) {
    ...
    public void renderMachine(List<BakedQuad> quads, MachineDefinition definition, @Nullable MetaMachine machine,
        ...
        super.renderMachine(quads, definition, machine, frontFacing, quadFace, rand, modelFacing, modelState, modelData,
                renderType);
        if (quadFace == Direction.DOWN) quads.add(
                StaticFaceBakery.bakeFace(modelFacing, ModelFactory.getBlockSprite(MinerModel.PIPE_IN_OVERLAY),
                        modelState));
    }
}
