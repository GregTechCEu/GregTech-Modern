...
public class LargeBoilerModel extends WorkableCasingMachineModel implements IControllerModelRenderer {
    ...
    public LargeBoilerModel(ResourceLocation texture, BoilerFireboxType firebox, ResourceLocation workableModel) {
