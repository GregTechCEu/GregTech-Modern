...
public class FusionReactorModel extends WorkableCasingMachineModel {
    ...
    public FusionReactorModel(ResourceLocation baseCasing, ResourceLocation workableModel) {
