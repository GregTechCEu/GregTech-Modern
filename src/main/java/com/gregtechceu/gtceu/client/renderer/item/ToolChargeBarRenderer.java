...
public final class ToolChargeBarRenderer {
    ...
    public static void render(GuiGraphics graphics, int level, int xPosition, int yPosition, int offset, boolean shadow,
        ...
        graphics.fill(RenderType.guiOverlay(), x, y, x + 13, y + (shadow ? 2 : 1), 0, colorShadow);
        DrawUtil.fillHorizontalGradient(graphics, RenderType.guiOverlay(), x, y, x + level, y + 1, left, right, 0);
