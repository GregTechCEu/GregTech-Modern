...
public final class EntryTypes<T extends VirtualEntry> {
    ...
    private static final Map<Identifier, EntryTypes<?>> TYPES_MAP = new Object2ObjectOpenHashMap<>();
    ...
    private EntryTypes(Identifier location, Supplier<T> supplier) {
        this.location = location;
        this.factory = supplier;
    }

    @Nullable
    public static EntryTypes<? extends VirtualEntry> fromLocation(Identifier location) {
