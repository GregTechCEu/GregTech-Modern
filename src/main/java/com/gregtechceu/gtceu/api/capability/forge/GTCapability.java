...
public class GTCapability {
    public static final BlockCapability<IEnergyContainer, Direction> CAPABILITY_ENERGY_CONTAINER = BlockCapability.createSided(GTCEu.id("energy_container"), IEnergyContainer.class);
    public static final BlockCapability<IEnergyInfoProvider, Direction> CAPABILITY_ENERGY_INFO_PROVIDER = BlockCapability.createSided(GTCEu.id("energy_info_provider"), IEnergyInfoProvider.class);
    public static final BlockCapability<ICoverable, Direction> CAPABILITY_COVERABLE = BlockCapability.createSided(GTCEu.id("coverable"), ICoverable.class);
    public static final BlockCapability<IToolable, Direction> CAPABILITY_TOOLABLE = BlockCapability.createSided(GTCEu.id("toolable"), IToolable.class);
    ...
    public static final BlockCapability<IOpticalComputationProvider, Direction> CAPABILITY_COMPUTATION_PROVIDER = BlockCapability.createSided(GTCEu.id("computation_provider"), IOpticalComputationProvider.class);
    public static final BlockCapability<IDataAccessHatch, Direction> CAPABILITY_DATA_ACCESS = BlockCapability.createSided(GTCEu.id("data_access"), IDataAccessHatch.class);
