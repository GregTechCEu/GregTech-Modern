...
public final class GeneratedVeinMetadata {
    ...
    public static GeneratedVeinMetadata readFromPacket(FriendlyByteBuf buf) {
        ...
        Holder<GTOreDefinition> def = GTRegistries.builtinRegistry().registryOrThrow(GTRegistries.Keys.ORE_VEIN)
                .getHolderOrThrow(buf.readResourceKey(GTRegistries.Keys.ORE_VEIN));
    ...
    public void writeToPacket(FriendlyByteBuf buf) {
        ...
        buf.writeResourceKey(definition.unwrapKey().orElseThrow());
    }
