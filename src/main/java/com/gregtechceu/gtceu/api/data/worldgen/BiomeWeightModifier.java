...
public class BiomeWeightModifier implements ToIntFunction<Holder<Biome>> {
    ...
    public static final Codec<BiomeWeightModifier> CODEC = GTCodecUtils
            .lazyInitialized(() -> GTCodecUtils.withAlternative(FromList.CODEC, SINGLE_CODEC, BiomeWeightModifier::flattenAndWrap))
