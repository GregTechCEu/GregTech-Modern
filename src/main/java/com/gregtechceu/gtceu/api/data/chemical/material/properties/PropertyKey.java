...
public class PropertyKey<T extends IMaterialProperty> {
    ...
    public static final PropertyKey<FluidPipeProperty> FLUID_PIPE = new PropertyKey<>("fluid_pipe",
            FluidPipeProperty.class);
    ...
    public static final PropertyKey<ItemPipeProperty> ITEM_PIPE = new PropertyKey<>("item_pipe",
            ItemPipeProperty.class);
