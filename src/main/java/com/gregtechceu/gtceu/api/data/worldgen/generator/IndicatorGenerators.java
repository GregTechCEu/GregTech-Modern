...
public class IndicatorGenerators {
    public static final MapCodec<NoopIndicatorGenerator> NO_OP = register(GTCEu.id("no_op"), NoopIndicatorGenerator.CODEC, entry -> NoopIndicatorGenerator.INSTANCE);
    ...
    public static <T extends IndicatorGenerator> MapCodec<T> register(ResourceLocation id, MapCodec<T> codec, Function<GTOreDefinition, T> function) {
