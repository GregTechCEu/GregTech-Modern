...
public sealed class Material implements Comparable<Material> permits MarkerMaterial {
     ...
     */
    public boolean shouldGenerateRecipesFor(@NotNull Holder<TagPrefix> prefix) {
    ...
    public static class Builder<P> extends HolderBuilder<Material, Material, P, Builder<P>> {
        ...
        private Set<Holder<TagPrefix>> ignoredTagPrefixes = null;
         ...
         */
        public Builder<P> fluid(@NotNull FluidStorageKey key, @NotNull FluidState state) {
         ...
         * @see FluidBuilder
         */
        public Builder<P> fluid(@NotNull FluidStorageKey key, @NotNull FluidBuilder builder) {
         ...
         * @see FluidBuilder
         */
        public Builder<P> liquid(@NotNull FluidBuilder builder) {
         ...
         * @see FluidBuilder
         */
        public Builder<P> plasma(@NotNull FluidBuilder builder) {
         ...
         * @see FluidBuilder
         */
        public Builder<P> gas(@NotNull FluidBuilder builder) {
    ...
    private static class MaterialInfo {
        ...
        @Getter
        @Setter
        private Holder<MaterialIconSet> iconSet;
