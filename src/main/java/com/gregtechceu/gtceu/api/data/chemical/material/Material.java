...
public sealed class Material implements Comparable<Material> permits MarkerMaterial {
     ...
     */
    @Getter
    private @UnknownNullability String chemicalFormula;
    ...
    private String calculateChemicalFormula() {
        ...
        if (materialInfo.element != null) {
            ...
            if (split.length > 1) {
                ...
                result = materialInfo.element.symbol();
            }
            return result;
        }
    ...
    public List<MaterialStack> getMaterialComponents() {
    ...
    public boolean shouldGenerateRecipesFor(Holder<TagPrefix> prefix) {
        return (!this.hasFlag(MaterialFlags.NO_UNIFICATION) || !this.hasFlag(MaterialFlags.DISABLE_MATERIAL_RECIPES)) &&
                !ChemicalHelper.getItems(new MaterialEntry(prefix, this)).isEmpty();
    }
     ...
     */
    public @UnknownNullability Fluid getFluid(FluidStorageKey key) {
        FluidProperty prop = getProperty(PropertyKey.FLUID);
        if (prop == null) {
            throw new IllegalArgumentException("Material " + getResourceLocation() + " does not have a Fluid!");
        }
     ...
     * @return the fluid corresponding with the key
     */
    public @UnknownNullability FluidBuilder getFluidBuilder(FluidStorageKey key) {
        FluidProperty prop = getProperty(PropertyKey.FLUID);
        if (prop == null) {
            throw new IllegalArgumentException("Material " + getResourceLocation() + " does not have a Fluid!");
        }
     ...
     */
    public @UnknownNullability Fluid getHotFluid() {
        if (hasProperty(PropertyKey.ALLOY_BLAST)) {
            return getFluid(FluidStorageKeys.MOLTEN);
        }
        if (!TagPrefix.ingotHot.get().doGenerateItem(this) && hasProperty(PropertyKey.FLUID)) {
    ...
    public void setMaterialIconSet(Holder<MaterialIconSet> iconSet) {
        materialInfo.iconSet = iconSet;
    }

    public MaterialIconSet getMaterialIconSet() {
        return materialInfo.iconSet.get();
    }
    ...
    public Holder<Material> getHolder() {
        return GTRegistries.MATERIALS.wrapAsHolder(this);
    }
    ...
    public static class Builder<P> extends HolderBuilder<Material, Material, P, Builder<P>> {

        private final MaterialInfo materialInfo;
        private final MaterialProperties properties;
        private final MaterialFlags flags;

        private @UnknownNullability Set<Holder<TagPrefix>> ignoredTagPrefixes = null;
        private final List<TagKey<Item>> itemTags = new ArrayList<>();

        /**
         * Temporary data used to determine the final material formula tooltip.
         */
        private @UnknownNullability String formula = null;
        ...
        /**
         * Constructs a {@link Material}. This Builder<P> replaces the old constructors, and
        ...
        public Builder(GTRegistrate owner, P parent, String name, BuilderCallback callback) {
            ...
            materialInfo = new MaterialInfo(owner.makeResourceLocation(name));
            properties = new MaterialProperties();
            flags = new MaterialFlags();
        }
         ...
         */
        public Builder<P> langValue(String name) {
         ...
         */
        public Builder<P> iconSet(Holder<MaterialIconSet> iconSet) {
            materialInfo.iconSet = iconSet;
            return this;
        }
         ...
         */
        public Builder<P> components(Object... components) {
         ...
         */
        @SafeVarargs
        public final Builder<P> ignoredTagPrefixes(Holder<TagPrefix>... prefixes) {
         ...
         */
        public Builder<P> washedIn(Holder<Material> m) {
            properties.ensureSet(PropertyKey.ORE);
         ...
         */
        public Builder<P> washedIn(Holder<Material> m, int washedAmount) {
            properties.ensureSet(PropertyKey.ORE);
         ...
         */
        @SafeVarargs
        public final Builder<P> separatedInto(Holder<Material>... m) {
            properties.ensureSet(PropertyKey.ORE);
         ...
         */
        public Builder<P> oreSmeltInto(Holder<Material> m) {
            properties.ensureSet(PropertyKey.ORE);
         ...
         */
        @Deprecated
        public Builder<P> addDefaultEnchant(Enchantment enchant, int level) {
        ...
        public Material createEntry() {
            ...
            onRegister(material -> {
                material.materialInfo.verifyInfo(material.properties, averageRGB);
            });
        ...
        @Override
        protected HolderRegistryEntry<Material> createEntryWrapper(RegistryObject<Material> delegate) {
            final HolderRegistryEntry<Material> wrapper = super.createEntryWrapper(delegate);
            properties.setMaterial(wrapper);

            if (ignoredTagPrefixes != null && !ignoredTagPrefixes.isEmpty()) {
                ignoredTagPrefixes.forEach(p -> p.get().setIgnored(wrapper));
            }
    ...
    private static class MaterialInfo {
        ...
        @Setter
        @Getter
        private @UnknownNullability String overriddenName;
        ...
        @Getter
        @Setter
        private @UnknownNullability Holder<MaterialIconSet> iconSet;
        ...
        @Setter
        @Unmodifiable
        private List<MaterialStack> componentList;
        ...
        @Getter
        @Setter
        private @UnknownNullability Element element;
