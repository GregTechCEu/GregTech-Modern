...
public final class Material {
    ...
    private Material(MaterialInfo materialInfo, MaterialProperties properties,
                     MaterialFlags flags) {
    ...
    public static class Builder {
        ...
        private @Nullable List<MaterialStackWrapper> compositionSupplier;
         ...
         */
        public Builder element(Holder<Element> element) {
