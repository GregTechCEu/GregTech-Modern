...
public class GTRecipe implements net.minecraft.world.item.crafting.Recipe<RecipeInput>, RecipeIdAware {
    ...
    @Override
    public void setRecipeId(Identifier id) {
        this.id = id;
    }
    ...
    @Override
    public @NotNull RecipeSerializer<GTRecipe> getSerializer() {
    ...
    public PlacementInfo placementInfo() {
        // Machines match capability contents through GT's recipe lookup, not vanilla crafting slots.
