...
public class ToolHeadReplaceRecipe extends CustomRecipe {
    public static SimpleRecipeSerializer<ToolHeadReplaceRecipe> SERIALIZER = new SimpleRecipeSerializer<>(ToolHeadReplaceRecipe::new);
    ...
    public ToolHeadReplaceRecipe(ResourceLocation id) {
        super(id);
    }
