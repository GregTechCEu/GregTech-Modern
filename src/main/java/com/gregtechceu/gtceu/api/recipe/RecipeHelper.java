...
public class RecipeHelper {
    ...
    public static ActionResult handleRecipe(IRecipeCapabilityHolder holder, GTRecipe recipe, IO io,
        ...
        String key = "gui.gtceu.recipe.insufficient_" + (io == IO.IN ? "in" : "out");
    ...
    public static ActionResult checkConditions(GTRecipe recipe, @NotNull RecipeLogic recipeLogic) {
        ...
        for (RecipeCondition condition : recipe.conditions) {
            if (condition.isOr()) {
                ...
                return ActionResult.fail(Component.translatable("gui.gtceu.recipe.condition_fails")
                        .append(": ")
        ...
        for (List<RecipeCondition> conditions : or.values()) {
            ...
            MutableComponent component = Component.translatable("gui.gtceu.recipe.condition_fails")
                    .append(": ");
