...
public record ContentOverlay(Content content, boolean perTick)
    ...
    public void drawChance(GuiGraphics graphics, float x, float y, int width, int height) {
        ...
        Component s = content.chance() == 0 ? Component.translatable("recipe.gtceu.content.chance_nc_short").withStyle(ChatFormatting.RED) :
    ...
    public void drawTick(GuiGraphics graphics, float x, float y, int width, int height) {
        ...
        Component s = Component.translatable("recipe.gtceu.content.tips.per_tick_short").withStyle(ChatFormatting.GREEN);
