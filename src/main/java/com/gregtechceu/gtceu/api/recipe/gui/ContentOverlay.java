...
public record ContentOverlay(Content content, boolean perTick)
    ...
    public void drawChance(GuiGraphics graphics, float x, float y, int width, int height) {
        ...
        Component s = content.chance() == 0 ? Component.translatable("recipe_content.gtceu.chance_nc_short").withStyle(ChatFormatting.RED) :
    ...
    public void drawTick(GuiGraphics graphics, float x, float y, int width, int height) {
        ...
        Component s = Component.translatable("recipe_content.gtceu.tips.per_tick_short").withStyle(ChatFormatting.GREEN);
