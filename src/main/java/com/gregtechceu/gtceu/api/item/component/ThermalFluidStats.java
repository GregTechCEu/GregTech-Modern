...
public class ThermalFluidStats implements IItemComponent, IComponentCapability, IAddInformation {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents,
        ...
        if (GTUtil.isShiftDown()) {
            tooltipComponents.add(Component.translatable("gtceu.fluid_container.max_temperature",
                    FormattingUtil.formatNumbers(maxFluidTemperature)));
            if (gasProof) tooltipComponents.add(Component.translatable("gtceu.fluid_container.gas_proof"));
            else tooltipComponents.add(Component.translatable("gtceu.fluid_container.not_gas_proof"));
            if (plasmaProof) tooltipComponents.add(Component.translatable("gtceu.fluid_container.plasma_proof"));
            if (cryoProof) tooltipComponents.add(Component.translatable("gtceu.fluid_container.cryo_proof"));
            if (acidProof) tooltipComponents.add(Component.translatable("gtceu.fluid_container.acid_proof"));
