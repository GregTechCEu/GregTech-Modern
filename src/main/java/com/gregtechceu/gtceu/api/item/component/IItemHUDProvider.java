...
public interface IItemHUDProvider extends IItemComponent {
     ...
     */
    @OnlyIn(Dist.CLIENT)
    default void drawHUD(ItemStack stack, GuiGraphicsExtractor guiGraphics) {}
     ...
     */
    @OnlyIn(Dist.CLIENT)
    static void tryDrawHud(@Nonnull IItemHUDProvider provider, @Nonnull ItemStack stack, GuiGraphicsExtractor guiGraphics) {
