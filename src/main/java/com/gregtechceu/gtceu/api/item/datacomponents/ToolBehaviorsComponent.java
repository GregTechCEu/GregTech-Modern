...
public record ToolBehaviorsComponent(List<IToolBehavior<?>> behaviors) {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ToolBehaviorsComponent> STREAM_CODEC = GTRegistries.TOOL_BEHAVIORS
            .streamCodec()
            .dispatch(IToolBehavior::getType,
                    type -> (StreamCodec<RegistryFriendlyByteBuf, IToolBehavior<?>>) type.getStreamCodec())
