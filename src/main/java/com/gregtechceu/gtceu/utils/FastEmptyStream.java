...
public class FastEmptyStream<T> implements Stream<T> {

    public static <T> FastEmptyStream<T> create(T[] array) {
        return new FastEmptyStream<>(array);
    }

    private final T[] array;

    private FastEmptyStream(T[] array) {
        this.array = array;
    }
