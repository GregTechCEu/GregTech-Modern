...
public class SupplierMemoizer {
     ...
     * Use this to save blocks to {@link com.gregtechceu.gtceu.api.materials.ChemicalHelper#registerUnificationItems(com.gregtechceu.gtceu.api.materials.material.stack.UnificationEntry, Supplier[])}
     */
