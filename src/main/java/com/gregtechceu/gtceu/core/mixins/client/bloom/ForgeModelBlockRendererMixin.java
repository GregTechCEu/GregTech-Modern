...
public class ForgeModelBlockRendererMixin {
    ...
    private static QuadLighter gtceu$setQuadLighterRenderType(QuadLighter lighter,
        ...
        // QuadLighter is a NeoForge class, so the QuadLighterExt interface is only mixed in at runtime
        // (interface injection does not apply to non-Minecraft classes); cast to call the injected method
