...
import static com.gregtechceu.gtceu.data.blocks.GTBlocks.createActiveCasing;
import static com.gregtechceu.gtceu.data.blocks.GTBlocks.createCasingBlock;
...
public class GCyMBlocks {
    ...
    public static final BlockEntry<ActiveBlock> SLICING_BLADES = createActiveCasing("slicing_blades", "block/variant/slicing_blades");
    public static final BlockEntry<ActiveBlock> MOLYBDENUM_DISILICIDE_COIL_BLOCK = createActiveCasing("molybdenum_disilicide_coil_block", "block/variant/molybdenum_disilicide_coil_block");
    public static final BlockEntry<ActiveBlock> ELECTROLYTIC_CELL = createActiveCasing("electrolytic_cell", "block/variant/electrolytic_cell");
    public static final BlockEntry<ActiveBlock> CRUSHING_WHEELS = createActiveCasing("crushing_wheels", "block/variant/crushing_wheels");
