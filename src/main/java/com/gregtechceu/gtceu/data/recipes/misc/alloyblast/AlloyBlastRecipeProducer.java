package com.gregtechceu.gtceu.data.recipes.misc.alloyblast;
...
import com.gregtechceu.gtceu.data.recipes.GCyMRecipeTypes;
...
public class AlloyBlastRecipeProducer {
     ...
     */
    @SuppressWarnings("MethodMayBeStatic")
    protected void addFreezerRecipes(@NotNull Material material, @NotNull Fluid molten, int temperature, RecipeOutput provider) {
