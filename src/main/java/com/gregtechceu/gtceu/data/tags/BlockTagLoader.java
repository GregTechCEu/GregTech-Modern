...
public class BlockTagLoader {
    ...
    public static void init(RegistrateTagsProvider.IntrinsicImpl<Block> provider) {
        provider.addTag(GTTags.Blocks.CONCRETES)
        ...
        provider.addTag(GTTags.Blocks.CONCRETE_POWDERS)
        ...
        var speedConcretes = provider.addTag(GTTags.Blocks.VERY_FAST_WALKABLE_BLOCKS);
        ...
        var studs = provider.addTag(GTTags.Blocks.FAST_WALKABLE_BLOCKS);
        GTBlocks.STUDS.forEach((color, block) -> studs.add(block.get()));

        provider.addTag(GTTags.Blocks.ENDSTONE_ORE_REPLACEABLES).add(Blocks.END_STONE);

        provider.addTag(GTTags.Blocks.TALL_PLANTS)
        ...
        provider.addTag(GTTags.Blocks.MINEABLE_WITH_WRENCH)
                .addTag(GTTags.Blocks.MINEABLE_WITH_CONFIG_VALID_PICKAXE_WRENCH)
        ...
        provider.addTag(GTTags.Blocks.MINEABLE_WITH_WIRE_CUTTER)
                .addTag(GTTags.Blocks.MINEABLE_WITH_CONFIG_VALID_PICKAXE_WIRE_CUTTER);

        provider.addTag(GTTags.Blocks.MINEABLE_WITH_SHEARS)
        ...
        provider.addTag(GTTags.Blocks.CLEANROOM_FLOORS)
        ...
        provider.addTag(GTTags.Blocks.CHARCOAL_PILE_IGNITER_WALLS)
        ...
        provider.addTag(GTTags.Blocks.CLEANROOM_DOORS).add(Blocks.IRON_DOOR).addTag(BlockTags.WOODEN_DOORS);
    }
}
