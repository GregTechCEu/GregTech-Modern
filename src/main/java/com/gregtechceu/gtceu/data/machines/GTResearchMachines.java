...
import com.gregtechceu.gtceu.common.machines.multiblock.electric.research.DataBankMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.electric.research.HPCAMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.electric.research.NetworkSwitchMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.electric.research.ResearchStationMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.DataAccessHatchMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.ObjectHolderMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.OpticalComputationHatchMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.OpticalDataHatchMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.hpca.HPCABridgePartMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.hpca.HPCAComputationPartMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.hpca.HPCACoolerPartMachine;
import com.gregtechceu.gtceu.common.machines.multiblock.part.hpca.HPCAEmptyPartMachine;
...
public class GTResearchMachines {
    ...
    public static final MachineDefinition DATA_BANK = REGISTRATE.multiblock("data_bank", DataBankMachine::new)
        ...
        .tooltips(Component.translatable("gtceu.machine.data_bank.tooltip.0"),
            ...
            Component.translatable("gtceu.machine.data_bank.tooltip.3", FormattingUtil.formatNumbers(DataBankMachine.EUT_PER_HATCH)),
            Component.translatable("gtceu.machine.data_bank.tooltip.4", FormattingUtil.formatNumbers(DataBankMachine.EUT_PER_HATCH_CHAINED)))
    ...
    public static final MachineDefinition NETWORK_SWITCH = REGISTRATE.multiblock("network_switch", NetworkSwitchMachine::new)
        ...
        .tooltips(Component.translatable("gtceu.machine.network_switch.tooltip.0"),
            ...
            Component.translatable("gtceu.machine.network_switch.tooltip.3", FormattingUtil.formatNumbers(NetworkSwitchMachine.EUT_PER_HATCH)))
        .pattern(definition -> FactoryBlockPattern.start()
            .aisle("XXX", "XXX", "XXX")
            .aisle("XXX", "XAX", "XXX")
            .aisle("XXX", "XSX", "XXX")
