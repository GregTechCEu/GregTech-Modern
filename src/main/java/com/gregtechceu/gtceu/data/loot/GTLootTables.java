    ...
    public static class ChestLoot implements LootTableSubProvider {
        ...
        private static LootPool.Builder simpleDungeonLoot() {
            return lootPool()
                    .add(lootTableItem(GTItems.BOTTLE_PURPLE_DRINK)
                            .setWeight(8)
                            .apply(setCount(between(4, 8))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Silver))
                            .setWeight(12)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Lead))
                            .setWeight(3)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Steel))
                            .setWeight(6)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Bronze))
                            .setWeight(6)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Manganese))
                            .setWeight(6)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.DamascusSteel))
                            .setWeight(1)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.Emerald))
                            .setWeight(2)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.Ruby))
                            .setWeight(2)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.Sapphire))
                            .setWeight(2)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.GreenSapphire))
                            .setWeight(2)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.Olivine))
                            .setWeight(2)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.GarnetRed))
                            .setWeight(2)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.GarnetYellow))
                            .setWeight(2)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.dust, GTMaterials.Neodymium))
                            .setWeight(4)
                            .apply(setCount(between(1, 6))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.dust, GTMaterials.Chromium))
                            .setWeight(4)
                            .apply(setCount(between(1, 6))));
        }
        ...
        private static LootPool.Builder desertPyramidLoot() {
            return lootPool()
                    ...
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Platinum))
                            .setWeight(4)
                            .apply(setCount(between(2, 8))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.gem, GTMaterials.Ruby))
                            .setWeight(2)
        ...
        private static LootPool.Builder villageWeaponsmithLoot() {
            return lootPool()
                    ...
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Bronze))
                            .setWeight(12)
                            .apply(setCount(between(4, 12))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.Brass))
                            .setWeight(12)
                            .apply(setCount(between(4, 12))))
                    .add(lootTableItem(ChemicalHelper.getItemOrThrow(TagPrefix.ingot, GTMaterials.DamascusSteel))
                            .setWeight(1)
