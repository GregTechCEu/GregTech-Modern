...
public class MachineRecipeLoader {
    ...
    private static void registerNBTRemoval(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapelessRecipe(provider, "fluid_filter_nbt", ITEM_FILTER.asStack(), ITEM_FILTER.asStack());
        VanillaRecipeHelper.addShapelessRecipe(provider, "fluid_filter_nbt", FLUID_FILTER.asStack(), FLUID_FILTER.asStack());
        VanillaRecipeHelper.addShapelessRecipe(provider, "item_tag_filter_nbt", ORE_DICTIONARY_FILTER.asStack(), ORE_DICTIONARY_FILTER.asStack());
        VanillaRecipeHelper.addShapelessRecipe(provider, "fluid_tag_filter_nbt", TAG_FLUID_FILTER.asStack(), TAG_FLUID_FILTER.asStack());
    }
