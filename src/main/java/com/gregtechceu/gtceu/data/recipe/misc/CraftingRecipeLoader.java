...
public class CraftingRecipeLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        // insulation wrapper
        VanillaRecipeHelper.addShapedRecipe(provider, true, "insulation_wrapper", INSULATION_WRAPPER.asStack(), "DDD",
                "WFW", "DDD",
                'D', new MaterialEntry(dust, Asbestos), 'W', new ItemStack(Items.WHITE_WOOL), 'F',
                new MaterialEntry(foil, Steel));
