...
public class RecipeRemoval {
    ...
    private static void hardMiscRecipes(Consumer<Identifier> registry) {
        ...
        for (DyeColor color : DyeColor.values()) {
            registry.accept(Identifier.tryParse(color.getName() + "_bed"));
        }
    ...
    private static void hardDyeRecipes(Consumer<Identifier> registry) {
        for (DyeColor col : DyeColor.values()) {
            ...
            registry.accept(
                    Identifier.withDefaultNamespace(String.format("%s_concrete_powder", color)));
            registry.accept(Identifier.withDefaultNamespace(String.format("%s_terracotta", color)));
            registry.accept(Identifier.withDefaultNamespace(String.format("%s_stained_glass", color)));
            registry.accept(Identifier.withDefaultNamespace(String.format("%s_candle", color)));
            registry.accept(Identifier.withDefaultNamespace(String.format("dye_%s_wool", color)));
            registry.accept(Identifier.withDefaultNamespace(String.format("dye_%s_carpet", color)));
            registry.accept(Identifier.withDefaultNamespace(String.format("dye_%s_bed", color)));
        }
