...
public class SeparationRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("sticky_resin_separation").duration(400).EUt(5)
                ...
                .chancedOutput(PLANT_BALL.asStack(), 1000, 0)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("rubber_log_separation").duration(200).EUt(20)
                ...
                .chancedOutput(STICKY_RESIN.asStack(), 5000, 0)
                .chancedOutput(PLANT_BALL.asStack(), 3750, 0)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("mycelium_separation").duration(650).EUt(VA[LV])
                ...
                .chancedOutput(new ItemStack(Blocks.RED_MUSHROOM), 2500, 0)
                .chancedOutput(new ItemStack(Blocks.BROWN_MUSHROOM), 2500, 0)
                .chancedOutput(new ItemStack(Blocks.SAND), 5000, 0)
                .chancedOutput(dust, Clay, 450, 0)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("uranium_238_separation").duration(800).EUt(320)
                ...
                .chancedOutput(dustTiny, Plutonium239, 200, 0)
                .chancedOutput(dustTiny, Uranium235, 2000, 0)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("plutonium_239_separation").duration(1600).EUt(320)
                .inputItems(dust, Plutonium239)
                .chancedOutput(dustTiny, Uranium238, 3000, 0)
                .chancedOutput(dust, Plutonium241, 2000, 0)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("endstone_separation").duration(320).EUt(20)
                ...
                .chancedOutput(dust, Tungstate, 315, 0)
                .chancedOutput(dust, Platinum, 70, 0)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("netherrack_separation").duration(160).EUt(20)
                ...
                .chancedOutput(dust, Redstone, 625, 0)
                .chancedOutput(dust, Gold, 70, 0)
                .chancedOutput(dust, Sulfur, 2475, 0)
                .chancedOutput(dust, Coal, 625, 0)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("soul_sand_separation").duration(200).EUt(80)
                .inputItems(Blocks.SOUL_SAND.asItem())
                .chancedOutput(new ItemStack(Blocks.SAND), 9000, 0)
                .chancedOutput(dust, Saltpeter, 2000, 0)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("rare_earth_separation").duration(64).EUt(20)
                ...
                .chancedOutput(dustSmall, Cadmium, 2500, 0)
                .chancedOutput(dustSmall, Neodymium, 2500, 0)
                .chancedOutput(dustSmall, Samarium, 2500, 0)
                .chancedOutput(dustSmall, Cerium, 2500, 0)
                .chancedOutput(dustSmall, Yttrium, 2500, 0)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("red_sand_separation").duration(50).EUt(VA[LV])
                ...
                .chancedOutput(dust, Diamond, 10, 0)
                .chancedOutput(new ItemStack(Blocks.SAND), 5000, 0)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("stone_dust_separation").duration(480).EUt(VA[MV])
                ...
                .chancedOutput(dust, MetalMixture, 825, 0)
                .chancedOutput(dust, Sodalite, 550, 0)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("metal_mixture_separation").duration(1000).EUt(900)
                ...
                .chancedOutput(dust, Chromite, 825, 0)
                .chancedOutput(dust, Ilmenite, 550, 0)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("quartz_sand_separation").duration(60).EUt(VA[LV])
                ...
                .chancedOutput(dust, CertusQuartz, 2000, 0)
                .save(provider);
        ...
        EXTRACTOR_RECIPES.recipeBuilder("wood_dust_extraction").duration(16).EUt(4)
                ...
                .chancedOutput(PLANT_BALL.asStack(), 200, 0)
