    ...
    private static ArrayList<WoodTypeEntry> getDefaultEntries() {
        if (DEFAULT_ENTRIES == null) {
            ...
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "oak")
                    ...
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "spruce")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "birch")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "jungle")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "acacia")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "dark_oak")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "bamboo")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "cherry")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "mangrove")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "crimson")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(mcModId, "warped")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(GTCEu.MOD_ID, "rubber")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new WoodTypeEntry.Builder(GTCEu.MOD_ID, "treated")
