...
public class CustomTags {
    ...
    public static final TagKey<Item> CORAL_BLOCKS = TagUtil.createModItemTag("coral_blocks");
    public static final TagKey<Item> CORALS = TagUtil.createModItemTag("corals");
