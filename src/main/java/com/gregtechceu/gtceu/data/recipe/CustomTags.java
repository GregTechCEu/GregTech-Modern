...
public class CustomTags {
    ...
    public static final TagKey<Item> RUBBER_LOGS_ITEM = TagUtil.createModItemTag("chests/wooden");
    ...
    public static final TagKey<Item> WOODEN_CHESTS = TagUtil.createModItemTag("chests/wooden");
