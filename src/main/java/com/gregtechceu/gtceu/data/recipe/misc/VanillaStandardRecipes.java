    ...
    private static void dyingCleaningRecipes(Consumer<FinishedRecipe> provider) {
        for (DyeColor color : DyeColor.values()) {
            ...
            MIXER_RECIPES.recipeBuilder(dyeName + "_concrete_powder").duration(200).EUt(VA[ULV])
                    ...
                    .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_concrete_powder")), 8))
                    .save(provider);

            CHEMICAL_BATH_RECIPES.recipeBuilder(dyeName + "_concrete").duration(20).EUt(VA[ULV])
                    .inputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_concrete_powder"))))
                    .inputFluids(Water.getFluid(1000))
                    .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_concrete"))))
                    .save(provider);
            ...
            CHEMICAL_BATH_RECIPES.recipeBuilder("dye_terracotta_to_" + dyeName).duration(20).EUt(VA[ULV])
                    ...
                    .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L / 8))
                    .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_terracotta"))))
                    .save(provider);

            CHEMICAL_BATH_RECIPES.recipeBuilder("dye_glass_to_" + dyeName).duration(20).EUt(VA[ULV])
                    .inputItems(new ItemStack(Blocks.GLASS))
                    .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L / 8))
                    .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_stained_glass"))))
                    .save(provider);
            ...
            CHEMICAL_BATH_RECIPES.recipeBuilder("dye_glass_pane_to_" + dyeName).duration(20).EUt(VA[ULV])
                    ...
                    .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L / 8))
                    .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_stained_glass_pane"))))
                    .save(provider);
            ...
            if(color != DyeColor.WHITE) {
                CHEMICAL_BATH_RECIPES.recipeBuilder("dye_wool_to_" + dyeName).duration(20).EUt(VA[ULV])
                        ...
                        .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L))
                        .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_wool"))))
                        .save(provider);
            }

            CUTTER_RECIPES.recipeBuilder("cut_" + dyeName + "_wool_to_carpet").duration(20).EUt(VA[ULV])
                    .inputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_wool")), 1))
                    .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_carpet")), 2))
                    .save(provider);

            ASSEMBLER_RECIPES.recipeBuilder(dyeName + "_banner").duration(20).EUt(VA[ULV])
                    .circuitMeta(6)
                    .inputItems(new ItemStack(Items.STICK))
                    .inputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_wool")), 6))
                    .outputItems(new ItemStack(Registry.ITEM.get(new ResourceLocation(dyeName + "_banner"))))
                    .save(provider);
        }
