...
public class CreateRecipes {
    ...
    public static void hardRedstoneRecipes(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "compat/create/powered_latch",
                new ItemStack(AllBlocks.POWERED_LATCH),
                "ST ", "dLS",
                "RPR",
                'S', new MaterialEntry(TagPrefix.screw, GTMaterials.Iron),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "compat/create/powered_toggle_latch",
                new ItemStack(AllBlocks.POWERED_TOGGLE_LATCH),
                "ST ", "dLS",
                "PPP",
                'S', new MaterialEntry(TagPrefix.screw, GTMaterials.Iron),
                'L', new ItemStack(Blocks.LEVER),
