...
public class MetaTileEntityLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "warning_sign_radioactive_hazard",
                ...
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_bio_hazard",
                GTBlocks.BIO_HAZARD_SIGN_BLOCK.asStack(), " Y ", " MB", "   ", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_explosion_hazard",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "warning_sign_fire_hazard",
                ...
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_acid_hazard",
                GTBlocks.ACID_HAZARD_SIGN_BLOCK.asStack(), " Y ", " M ", "B  ", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_magic_hazard",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "warning_sign_frost_hazard",
                ...
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_noise_hazard",
                GTBlocks.NOISE_HAZARD_SIGN_BLOCK.asStack(), "   ", " M ", "BY ", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_generic_hazard",
                GTBlocks.GENERIC_HAZARD_SIGN_BLOCK.asStack(), "   ", "BM ", " Y ", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_high_voltage_hazard",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "warning_sign_magnetic_hazard",
                ...
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_antimatter_hazard",
                GTBlocks.ANTIMATTER_HAZARD_SIGN_BLOCK.asStack(), "  B", " M ", " Y ", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_high_temperature_hazard",
                GTBlocks.HIGH_TEMPERATURE_HAZARD_SIGN_BLOCK.asStack(), "   ", " MB", " Y ", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_void_hazard",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "warning_gregification_hazard",
                ...
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_causality_hazard",
                GTBlocks.CAUSALITY_HAZARD_SIGN_BLOCK.asStack(), "   ", "YM ", "B  ", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_turret_hazard",
                GTBlocks.TURRET_HAZARD_SIGN_BLOCK.asStack(), "   ", " MY", "  B", 'M',
                GTBlocks.CASING_STEEL_SOLID.asStack(), 'Y', Tags.Items.DYES_YELLOW, 'B', Tags.Items.DYES_BLACK);
        VanillaRecipeHelper.addStrictShapedRecipe(provider, "warning_sign_high_pressure_hazard",
