...
public class MetaTileEntityLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_rock_breaker_steel",
                ...
                new UnificationEntry(TagPrefix.plate, GTMaterials.Steel), 'P',
                new UnificationEntry(TagPrefix.pipeSmallFluid, GTMaterials.TinAlloy));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_miner_bronze", GTMachines.STEAM_MINER.first().asStack(), "DSD",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_miner_steel", GTMachines.STEAM_MINER.second().asStack(), "DSD",
                "SMS", "GSG", 'M', GTMachines.STEAM_MINER.first().asStack(), 'S',
                new UnificationEntry(TagPrefix.pipeNormalFluid, GTMaterials.TinAlloy), 'D',
                new UnificationEntry(TagPrefix.gem, GTMaterials.Diamond), 'G',
                new UnificationEntry(TagPrefix.gearSmall, GTMaterials.Steel));
