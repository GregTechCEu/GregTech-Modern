...
public class StoneMachineRecipes {
    ...
    private static List<StoneTypeEntry> getDefaultEntries() {
        if (DEFAULT_ENTRIES == null) {
            ...
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "stone")
                    .stone(Items.STONE)
                    ...
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "smooth_stone")
                    .stone(Items.SMOOTH_STONE)
                    .slab(Items.SMOOTH_STONE_SLAB)
                    .material(GTMaterials.Stone)
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "stone_brick")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "andesite")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "polished_andesite")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "granite")
                    .stone(Items.GRANITE)
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "polished_granite")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "diorite")
                    .stone(Items.DIORITE)
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "polished_diorite")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "sandstone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "smooth_sandstone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "cut_sandstone")
                    .stone(Items.CUT_SANDSTONE)
                    .slab(Items.CUT_STANDSTONE_SLAB)
                    .material(GTMaterials.QuartzSand)
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "red_sandstone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "smooth_red_sandstone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "cut_red_sandstone")
                    .stone(Items.CUT_RED_SANDSTONE)
                    .slab(Items.CUT_RED_SANDSTONE_SLAB)
                    .material(GTMaterials.QuartzSand)
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "cobblestone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "mossy_cobblestone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "mossy_stone_brick")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "blackstone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "polished_blackstone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "polished_blackstone_brick")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "brick")
                    .stone(Items.BRICKS)
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "mud_brick")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "nether_bricks")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "red_nether_brick")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "quartz")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "smooth_quartz")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "exposed_cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "oxidized_cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "weathered_cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "waxed_cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "waxed_exposed_cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "waxed_oxidized_cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "waxed_weathered_cut_copper")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "purpur")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "end_stone")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "prismarine")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "dark_prismarine")
                    .stone(Items.DARK_PRISMARINE)
                    .slab(Items.DARK_PRISMARINE_SLAB)
                    .stair(Items.DARK_PRISMARINE_STAIRS)
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "prismarine_brick")
                    .stone(Items.PRISMARINE_BRICKS)
                    .slab(Items.PRISMARINE_BRICK_SLAB)
                    .stair(Items.PRISMARINE_BRICK_STAIRS)
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "bamboo_mosaic")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "deepslate")
                    .stone(Items.DEEPSLATE)
                    .crackedStone(Items.COBBLED_DEEPSLATE)
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "cobbled_deepslate")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "polished_deepslate")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "deepslate_bricks")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "deepslate_tile")
                    ...
                    .registerAllMaterialInfo()
                    .build());
            DEFAULT_ENTRIES.add(new StoneTypeEntry.Builder(mcModID, "basalt")
                    .stone(Items.BASALT)
