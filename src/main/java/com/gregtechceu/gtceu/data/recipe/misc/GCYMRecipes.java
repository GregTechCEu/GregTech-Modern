...
public class GCYMRecipes {
    ...
    private static void registerMultiblockControllerRecipes(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_macerator", LARGE_MACERATION_TOWER.asStack(), "PCP",
                ...
                new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_engraver", LARGE_ENGRAVING_LASER.asStack(), "ICI",
                "EXE", "PKP", 'C', CustomTags.IV_CIRCUITS, 'P', new MaterialEntry(PLATE_DOUBLE, TantalumCarbide), 'I',
                EMITTER_IV.asStack(), 'E', ELECTRIC_PISTON_IV.asStack(), 'X', LASER_ENGRAVER[IV].asStack(), 'K',
                new MaterialEntry(TagPrefix.CABLE_GT_SINGLE, Platinum));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_mixer", LARGE_MIXER.asStack(), "FCF", "RXR", "MKM",
                'C', CustomTags.IV_CIRCUITS, 'F', ChemicalHelper.get(PIPE_NORMAL_FLUID, Polybenzimidazole), 'R',
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_centrifuge", LARGE_CENTRIFUGE.asStack(), "SFS",
                "CXC", "MKM", 'C', CustomTags.IV_CIRCUITS, 'F', ChemicalHelper.get(PIPE_HUGE_FLUID, StainlessSteel),
                'S',
                ChemicalHelper.get(SPRING, MolybdenumDisilicide), 'M', ELECTRIC_MOTOR_IV.asStack(), 'X',
                CENTRIFUGE[IV].asStack(), 'K', new MaterialEntry(TagPrefix.CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_assembler", LARGE_ASSEMBLER.asStack(), "RKR", "CXC",
                ...
                ASSEMBLER[IV].asStack(), 'K', new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_electrolyzer", LARGE_ELECTROLYZER.asStack(), "PCP",
                ...
                new MaterialEntry(CABLE_GT_SINGLE, Platinum), 'X', ELECTROLYZER[IV].asStack(), 'K',
                new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_electromagnet", LARGE_ELECTROMAGNET.asStack(), "PWP",
                ...
                new MaterialEntry(WIRE_GT_QUADRUPLE, Osmium), 'X', ELECTROMAGNETIC_SEPARATOR[IV].asStack(), 'K',
                new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "blast_alloy_smelter", BLAST_ALLOY_SMELTER.asStack(), "TCT",
                ...
                new MaterialEntry(CABLE_GT_SINGLE, Aluminium), 'X', ALLOY_SMELTER[EV].asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "mega_blast_furnace", MEGA_BLAST_FURNACE.asStack(), "PCP",
                ...
                new MaterialEntry(PLATE_DENSE, NaquadahAlloy), 'W',
                new MaterialEntry(WIRE_GT_QUADRUPLE, RutheniumTriniumAmericiumNeutronate));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "mega_vacuum_freezer", MEGA_VACUUM_FREEZER.asStack(), "PCP",
                ...
                new MaterialEntry(PIPE_NORMAL_FLUID, NiobiumTitanium), 'D',
                new MaterialEntry(PLATE_DENSE, RhodiumPlatedPalladium), 'W',
                new MaterialEntry(WIRE_GT_QUADRUPLE, RutheniumTriniumAmericiumNeutronate));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_autoclave", LARGE_AUTOCLAVE.asStack(), "PCP", "PAP",
                ...
                new MaterialEntry(PLATE_DOUBLE, HSLASteel), 'B', ELECTRIC_PUMP_IV.asStack(), 'K',
                new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_material_press", LARGE_MATERIAL_PRESS.asStack(),
                ...
                FORGE_HAMMER[IV].asStack(), 'K', new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_brewer", LARGE_BREWER.asStack(), "SZS", "FBH", "EKE",
                ...
                FLUID_HEATER[IV].asStack(), 'K', new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_cutter", LARGE_CUTTER.asStack(), "SMS", "CZL", "EKE",
                ...
                new MaterialEntry(TOOL_HEAD_BUZZ_SAW, TungstenCarbide), 'K',
                new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_distillery", LARGE_DISTILLERY.asStack(), "PZP",
                ...
                ELECTRIC_PUMP_IV.asStack(), 'P', ChemicalHelper.get(PIPE_LARGE_FLUID, Iridium));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_extruder", LARGE_EXTRUDER.asStack(), "PZP", "SES",
                ...
                new MaterialEntry(SPRING, MolybdenumDisilicide), 'K', new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_solidifier", LARGE_SOLIDIFIER.asStack(), "PZP",
                ...
                ELECTRIC_PUMP_IV.asStack(), 'P', ChemicalHelper.get(PIPE_NORMAL_FLUID, Polyethylene), 'K',
                new MaterialEntry(CABLE_GT_SINGLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_wiremill", LARGE_WIREMILL.asStack(), "PZP", "SWS",
                ...
                ELECTRIC_MOTOR_IV.asStack(), 'K', new MaterialEntry(CABLE_GT_SINGLE, Platinum));
    }
    ...
    private static void registerPartsRecipes(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapedRecipe(provider, "crushing_wheels", CRUSHING_WHEELS.asStack(2), "TTT", "UCU",
                "UMU", 'T', new MaterialEntry(GEAR_SMALL, TungstenCarbide), 'U', ChemicalHelper.get(GEAR, Ultimet),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "electrolytic_cell", ELECTROLYTIC_CELL.asStack(2), "WWW", "WCW",
                "ZKZ", 'W', new MaterialEntry(WIRE_GT_DOUBLE, Platinum), 'Z', CustomTags.IV_CIRCUITS, 'C',
                CASING_NONCONDUCTING.asStack(), 'K', ChemicalHelper.get(CABLE_GT_SINGLE, Tungsten));
        VanillaRecipeHelper.addShapedRecipe(provider, "heat_vent", HEAT_VENT.asStack(2), "PDP", "RLR", "PDP", 'P',
                ...
                ChemicalHelper.get(PLATE_DOUBLE, MolybdenumDisilicide), 'R', ChemicalHelper.get(ROTOR, Titanium), 'L',
                ChemicalHelper.get(ROD_LONG, MolybdenumDisilicide));
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk1", PARALLEL_HATCH[IV].asStack(1), "SZE", "ZHZ",
                ...
                'C', new MaterialEntry(CABLE_GT_DOUBLE, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk2", PARALLEL_HATCH[LuV].asStack(1), "SZE",
                ...
                HULL[LuV].asStack(), 'C', new MaterialEntry(CABLE_GT_DOUBLE, NiobiumTitanium));
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk3", PARALLEL_HATCH[ZPM].asStack(1), "SZE",
                ...
                HULL[ZPM].asStack(), 'C', new MaterialEntry(CABLE_GT_DOUBLE, VanadiumGallium));
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk4", PARALLEL_HATCH[UV].asStack(1), "SZE", "ZHZ",
                ...
                'C', new MaterialEntry(CABLE_GT_DOUBLE, YttriumBariumCuprate));
    }
    ...
    private static void registerAssemblerRecipes(Consumer<FinishedRecipe> provider) {
        ASSEMBLER_RECIPES.recipeBuilder("crushing_wheels")
                .inputItems(GEAR_SMALL, TungstenCarbide, 2)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("electrolytic_cell")
                .inputItems(WIRE_GT_DOUBLE, Platinum, 4)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_incoloy_vibration_safe")
                ...
                .inputItems(FRAME_GT, IncoloyMA956)
                .circuitMeta(6)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_watertight")
                ...
                .inputItems(FRAME_GT, WatertightSteel)
                .circuitMeta(6)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_high_temperature_smelting")
                ...
                .inputItems(FRAME_GT, TungstenCarbide)
                .circuitMeta(6)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_reaction_safe_mixing")
                ...
                .inputItems(TagPrefix.FRAME_GT, GTMaterials.MaragingSteel300)
                .circuitMeta(6)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_shock_proof")
                ...
                .inputItems(FRAME_GT, HastelloyC276)
                .circuitMeta(6)
