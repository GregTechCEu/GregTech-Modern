...
public class ComponentRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        for (Map.Entry<String, Material> materialEntry : rubberMaterials.entrySet()) {
            ...
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber), new ResourceLocation(material.getModid(), String.format("conveyor_module_lv_%s", name)), CONVEYOR_MODULE_LV.asStack(), "RRR", "MCM", "RRR", 'R', new UnificationEntry(plate, material), 'C', new UnificationEntry(cableGtSingle, Tin), 'M', ELECTRIC_MOTOR_LV.asStack());
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber), new ResourceLocation(material.getModid(), String.format("conveyor_module_mv_%s", name)), CONVEYOR_MODULE_MV.asStack(), "RRR", "MCM", "RRR", 'R', new UnificationEntry(plate, material), 'C', new UnificationEntry(cableGtSingle, Copper), 'M', ELECTRIC_MOTOR_MV.asStack());
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber), new ResourceLocation(material.getModid(), String.format("conveyor_module_hv_%s", name)), CONVEYOR_MODULE_HV.asStack(), "RRR", "MCM", "RRR", 'R', new UnificationEntry(plate, material), 'C', new UnificationEntry(cableGtSingle, Gold), 'M', ELECTRIC_MOTOR_HV.asStack());
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber), new ResourceLocation(material.getModid(), String.format("conveyor_module_ev_%s", name)), CONVEYOR_MODULE_EV.asStack(), "RRR", "MCM", "RRR", 'R', new UnificationEntry(plate, material), 'C', new UnificationEntry(cableGtSingle, Aluminium), 'M', ELECTRIC_MOTOR_EV.asStack());
            if (!materialEntry.getValue().equals(Rubber))
                VanillaRecipeHelper.addShapedRecipe(provider, material.equals(SiliconeRubber), new ResourceLocation(material.getModid(), String.format("conveyor_module_iv_%s", materialEntry.getKey())), CONVEYOR_MODULE_IV.asStack(), "RRR", "MCM", "RRR", 'R', new UnificationEntry(plate, material), 'C', new UnificationEntry(cableGtSingle, Tungsten), 'M', ELECTRIC_MOTOR_IV.asStack());
