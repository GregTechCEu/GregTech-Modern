package com.gregtechceu.gtceu.data.entities;
...
import com.gregtechceu.gtceu.common.entities.PowderbarrelEntity;
...
public class GTEntityTypes {
    ...
    public static final EntityEntry<DynamiteEntity> DYNAMITE = REGISTRATE.<DynamiteEntity>entity("dynamite", DynamiteEntity::new, MobCategory.MISC)
        .lang("Dynamite")
        .properties(builder -> builder.sized(0.25F, 0.25F).fireImmune().clientTrackingRange(4).updateInterval(10))
        .tag(EntityTypeTags.IMPACT_PROJECTILES)
        .register();

    public static final EntityEntry<PowderbarrelEntity> POWDERBARREL = REGISTRATE.<PowderbarrelEntity>entity("powderbarrel", PowderbarrelEntity::new, MobCategory.MISC)
        .lang("Powderbarrel")
