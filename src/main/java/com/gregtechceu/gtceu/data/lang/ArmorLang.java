...
public class ArmorLang {
    ...
    private static void generateArmorMessageKeys(GTLangProvider provider) {
        ...
        provider.add("armor.gtceu.nano_muscle_suite.night_vision.disabled",
                " NanoMuscle™ Suite: §cNightVision Disabled");
        provider.add("armor.gtceu.nano_muscle_suite.night_vision.error", "NanoMuscle™ Suite: §cNot enough power!");
        ...
        // Quantum Suit
        provider.add("armor.gtceu.quark_tech_suite.night_vision.enabled", "QuarkTech™ Suite: §aNightVision Enabled");
        provider.add("armor.gtceu.quark_tech_suite.night_vision.disabled", "QuarkTech™ Suite: §cNightVision Disabled");
        provider.add("armor.gtceu.quark_tech_suite.night_vision.error", "QuarkTech™ Suite: §cNot enough power!");
    ...
    private static void generateTooltipKeys(GTLangProvider provider) {
        ...
        provider.add("armor.gtceu.tooltip.fall_damage", "§7Nullifies Fall Damage");
        ...
        provider.add("armor.gtceu.tooltip.auto_eat", "§7Replenishes Food Bar by Using Food from Inventory");
        ...
        provider.add("armor.gtceu.energy_share.tooltip.info", "To change mode, SHIFT + R-CLICK when holding item");
    }

    private static void generateHudKeys(GTLangProvider provider) {
        // HUD Information
        provider.add("armor.gtceu.hud.enabled", "§aON"); // change this to generic tooltip?
        provider.add("armor.gtceu.hud.disabled", "§cOFF");
        provider.add("armor.gtceu.hud.energy_level", "Energy Level: %s");
        provider.add("armor.gtceu.hud.engine", "Engine: %s");
