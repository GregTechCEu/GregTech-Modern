...
public class ItemLang {
    ...
    public static void generateBehaviorKeys(GTLangProvider provider) {
        // Item Behaviors
        provider.add("item.gtceu.behaviour.hoe", "Can till dirt");
        provider.add("item.gtceu.behaviour.soft_hammer", "Activates and Deactivates Machines");
        provider.add("item.gtceu.behaviour.soft_hammer.enabled", "Working Enabled");
        provider.add("item.gtceu.behaviour.soft_hammer.disabled", "Working Disabled");
        provider.add("item.gtceu.behaviour.soft_hammer.disabled_cycle", "Working disabled after current cycle");

        provider.add("item.gtceu.behaviour.lighter.tooltip.description", "Can light things on fire");
        provider.add("item.gtceu.behaviour.lighter.tooltip.usage", "Shift-right click to open/close");
        provider.add("item.gtceu.behaviour.lighter.fluid.tooltip", "Can light things on fire with Butane or Propane");
        provider.add("item.gtceu.behaviour.lighter.uses", "Remaining uses: %d");

        provider.add("item.gtceu.behaviour.toggle_energy.tooltip", "Use to toggle mode");
        provider.add("item.gtceu.behaviour.hammer", "Turns on and off Muffling for Machines (by hitting them)");
        
        // Magnet
        provider.add("item.gtceu.behaviour.itemmagnet.enabled", "§aMagnetic Field Enabled");
        provider.add("item.gtceu.behaviour.itemmagnet.disabled", "§cMagnetic Field Disabled");

        // Wrench Configuration
        provider.add("item.gtceu.behaviour.toolmode.mode", "§aConfiguration Mode:§r %s");
        provider.add("item.gtceu.behaviour.toolmode.fluid", "§9Fluid§r");
        provider.add("item.gtceu.behaviour.toolmode.item", "§6Item§r");
        provider.add("item.gtceu.behaviour.toolmode.both", "§dBoth (Fluid And Item)§r");

        // Spray can
        provider.add("item.gtceu.behaviour.spraypaint.solvent.tooltip", "Can remove color from things");
        provider.add("item.gtceu.behaviour.spraypaint.white.tooltip", "Can paint things in White");
        provider.add("item.gtceu.behaviour.spraypaint.orange.tooltip", "Can paint things in Orange");
        provider.add("item.gtceu.behaviour.spraypaint.magenta.tooltip", "Can paint things in Magenta");
        provider.add("item.gtceu.behaviour.spraypaint.light_blue.tooltip", "Can paint things in Light Blue");
        provider.add("item.gtceu.behaviour.spraypaint.yellow.tooltip", "Can paint things in Yellow");
        provider.add("item.gtceu.behaviour.spraypaint.lime.tooltip", "Can paint things in Lime");
        provider.add("item.gtceu.behaviour.spraypaint.pink.tooltip", "Can paint things in Pink");
        provider.add("item.gtceu.behaviour.spraypaint.gray.tooltip", "Can paint things in Gray");
        provider.add("item.gtceu.behaviour.spraypaint.light_gray.tooltip", "Can paint things in Light Gray");
        provider.add("item.gtceu.behaviour.spraypaint.cyan.tooltip", "Can paint things in Cyan");
        provider.add("item.gtceu.behaviour.spraypaint.purple.tooltip", "Can paint things in Purple");
        provider.add("item.gtceu.behaviour.spraypaint.blue.tooltip", "Can paint things in Blue");
        provider.add("item.gtceu.behaviour.spraypaint.brown.tooltip", "Can paint things in Brown");
        provider.add("item.gtceu.behaviour.spraypaint.green.tooltip", "Can paint things in Green");
        provider.add("item.gtceu.behaviour.spraypaint.red.tooltip", "Can paint things in Red");
        provider.add("item.gtceu.behaviour.spraypaint.black.tooltip", "Can paint things in Black");
        provider.add("item.gtceu.behaviour.spraypaint.uses", "Remaining Uses: %d");

        // Copy/Paste Configuration
        provider.add("item.gtceu.behaviour.memorycard.tooltip.copy",
                "§7Sneak + R-Click to copy configuration, or clear stored data if a block other than a machine or pipe is targeted.");
        provider.add("item.gtceu.behaviour.memorycard.tooltip.paste", "§7R-Click to paste machine configuration");
        provider.add("item.gtceu.behaviour.memorycard.tooltip.view_stored", "§8<Sneak to view stored configuration>");
        provider.add("item.gtceu.behaviour.memorycard.client_msg.cleared", "Stored configuration cleared");
        provider.add("item.gtceu.behaviour.memorycard.client_msg.copied", "Copied machine configuration");
        provider.add("item.gtceu.behaviour.memorycard.client_msg.pasted", "Applied machine configuration");
        provider.add("item.gtceu.behaviour.memorycard.client_msg.missing_items", "Missing items required to paste configuration");
        provider.add("item.gtceu.behaviour.memorycard.tooltip.items_to_paste",
                "The following items are needed to paste this configuration:");
        provider.add("item.gtceu.behaviour.memorycard.enabled", "§aEnabled§r");
        provider.add("item.gtceu.behaviour.memorycard.disabled", "§cDisabled§r");
        provider.add("item.gtceu.behaviour.memorycard.copy_target", "Copying: %s");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.item_io", "Item Output: %s (%s)");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.fluid_io", "Fluid Output: %s (%s)");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.auto_output", "§2Auto Output§r");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.allow_input", "§2Allow Input§r");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.auto_output_allow_input", "§2Auto Output/Allow Input§r");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.pipe_connections", "Pipe connections: %s");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.pipe_blocked_connections", "Pipe shuttered sides: %s");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.muffled", "Muffling %s");
        provider.add("item.gtceu.behaviour.memorycard.setting.tooltip.circuit_config", "Programmed Circuit: ");
        ...
        provider.add("item.gtceu.behaviour.prospector.not_enough_energy", "Not Enough Energy!");
        provider.add("item.gtceu.behaviour.prospector.added_waypoint", "Created waypoint named %s!");
        
        provider.add("item.gtceu.behaviour.portablescanner.bedrock_fluid.amount", "Fluid In Deposit: %s %s - %s%%");
        provider.add("item.gtceu.behaviour.portablescanner.bedrock_fluid.amount_unknown", "Fluid In Deposit: %s%%");
        provider.add("item.gtceu.behaviour.portablescanner.bedrock_fluid.nothing", "Fluid In Deposit: §6Nothing§r");

        provider.add("item.gtceu.behaviour.portablescanner.environmental_hazard", "Environmental Hazard In Chunk: %s§r - %s ppm");
        provider.add("item.gtceu.behaviour.portablescanner.environmental_hazard.nothing",
                "Environmental Hazard In Chunk: §6Nothing§r");

        provider.add("item.gtceu.behaviour.portablescanner.local_hazard", "Local Hazard In Area: %s§r - %s ppm");
        provider.add("item.gtceu.behaviour.portablescanner.local_hazard.nothing", "Local Hazard In Area: §6Nothing§r");

        provider.add("item.gtceu.behaviour.portablescanner.block_hardness", "Hardness: %s Blast Resistance: %s");
        provider.add("item.gtceu.behaviour.portablescanner.block_name", "Name: %s MetaData: %s");

        provider.add("item.gtceu.behaviour.portablescanner.debug_cpu_load",
                "Average CPU load of ~%sns over %s ticks with worst time of %sns.");
        provider.add("item.gtceu.behaviour.portablescanner.debug_cpu_load_seconds", "This is %s seconds.");
        provider.add("item.gtceu.behaviour.portablescanner.debug_lag_count",
                "Caused %s Lag Spike Warnings (anything taking longer than %sms) on the Server.");
        provider.add("item.gtceu.behaviour.portablescanner.debug_machine", "Meta-ID: %s");
        provider.add("item.gtceu.behaviour.portablescanner.debug_machine_invalid", " invalid!");
        provider.add("item.gtceu.behaviour.portablescanner.debug_machine_valid", " valid");

        provider.add("item.gtceu.behaviour.portablescanner.divider", "=========================");

        provider.add("item.gtceu.behaviour.portablescanner.energy_container_in", "Max IN: %s (%s) EU at %s A");
        provider.add("item.gtceu.behaviour.portablescanner.energy_container_out", "Max OUT: %s (%s) EU at %s A");
        provider.add("item.gtceu.behaviour.portablescanner.energy_container_storage", "Energy: %s EU / %s EU");

        provider.add("item.gtceu.behaviour.portablescanner.eu_per_sec", "Average (last second): %s EU/t");
        provider.add("item.gtceu.behaviour.portablescanner.amp_per_sec", "Average (last second): %s A");
        provider.add("item.gtceu.behaviour.portablescanner.machine_disabled", "Disabled.");

        provider.add("item.gtceu.behaviour.portablescanner.machine_front_facing", "Front Facing: %s");
        provider.add("item.gtceu.behaviour.portablescanner.machine_upwards_facing", "Upwards Facing: %s");

        provider.add("item.gtceu.behaviour.portablescanner.machine_ownership", "§2Machine Owner Type: %s§r");
        provider.add("item.gtceu.behaviour.portablescanner.guild_name", "§2Guild Name: %s§r");
        provider.add("item.gtceu.behaviour.portablescanner.team_name", "§2Team Name: %s§r");
        provider.add("item.gtceu.behaviour.portablescanner.player_name", "§2Player Name: %s§r, §7Player Online: %s§r");

        provider.add("item.gtceu.behaviour.portablescanner.machine_power_loss", "Shut down due to power loss.");
        provider.add("item.gtceu.behaviour.portablescanner.machine_progress", "Progress/Load: %s / %s");

        provider.add("item.gtceu.behaviour.portablescanner.muffled", "Muffled.");

        provider.add("item.gtceu.behaviour.portablescanner.multiblock_energy_input",
                "Max Energy Income: %s EU/t Tier: %s");
        provider.add("item.gtceu.behaviour.portablescanner.multiblock_energy_output",
                "Max Energy Output: %s EU/t Tier: %s");
        provider.add("item.gtceu.behaviour.portablescanner.multiblock_maintenance", "Problems: %s");
        provider.add("item.gtceu.behaviour.portablescanner.multiblock_parallel", "Multi Processing: %s");

        provider.add("item.gtceu.behaviour.portablescanner.position", "----- X: %s Y: %s Z: %s D: %s -----");
        provider.add("item.gtceu.behaviour.portablescanner.state", "%s: %s");
        provider.add("item.gtceu.behaviour.portablescanner.tank", "Tank %s: %s mB / %s mB %s");
        provider.add("item.gtceu.behaviour.portablescanner.tanks_empty", "All Tanks Empty");

        provider.add("item.gtceu.behaviour.portablescanner.workable_consumption", "Probably Uses: %s EU/t at %s A");
        provider.add("item.gtceu.behaviour.portablescanner.workable_production", "Probably Produces: %s EU/t at %s A");
        provider.add("item.gtceu.behaviour.portablescanner.workable_progress", "Progress: %s s / %s s");
        provider.add("item.gtceu.behaviour.portablescanner.workable_stored_energy", "Stored Energy: %s EU / %s EU");

        provider.add("item.gtceu.behaviour.portablescanner.mode.caption", "Display mode: %s");
        provider.add("item.gtceu.behaviour.portablescanner.mode.show_all_info", "Show all info (excluding internal info)");
        provider.add("item.gtceu.behaviour.portablescanner.mode.show_block_info", "Show block info");
        provider.add("item.gtceu.behaviour.portablescanner.mode.show_machine_info", "Show machine info");
        provider.add("item.gtceu.behaviour.portablescanner.mode.show_electrical_info", "Show electrical info");
        provider.add("item.gtceu.behaviour.portablescanner.mode.show_recipe_info", "Show recipe info");
        provider.add("item.gtceu.behaviour.portablescanner.mode.show_environmental_info", "Show environmental info");
        provider.add("item.gtceu.behaviour.portablescanner.mode.show_internal_info", "Show internal debugging info");

        // Data Stick
        provider.add("item.gtceu.behaviour.dataitem.title", "§n%s Construction Data:");
        provider.add("item.gtceu.behaviour.dataitem.data", "- §a%s");
