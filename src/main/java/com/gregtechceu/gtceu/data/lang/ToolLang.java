...
public class ToolLang {
    ...
    private static void initDeathMessages(RegistrateLangProvider provider) {
        ...
        provider.add("death.attack.gtceu.explosion", "%s was exploded");
        provider.add("death.attack.gtceu.explosion.player", "%s was exploded by %s");
        ...
        provider.add("death.attack.gtceu.file", "%s was filed D for 'Dead' by %s");
