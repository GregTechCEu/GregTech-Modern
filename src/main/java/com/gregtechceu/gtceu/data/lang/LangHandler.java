...
public class LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("gtceu.placeholder_info.calc",
        ...
        provider.add("gtceu.placeholder_info.if",
        ...
        provider.add("gtceu.placeholder_info.tick",
        ...
        provider.add("gtceu.placeholder_info.repeat",
        ...
        provider.add("gtceu.placeholder_info.fluidCount",
        ...
        provider.add("gtceu.placeholder_info.displayTarget",
        ...
        provider.add("gtceu.placeholder_info.previousText",
        ...
        provider.add("gtceu.gui.computer_monitor_cover.placeholder_reference",
                "All placeholders:\n(hover for more info)");
