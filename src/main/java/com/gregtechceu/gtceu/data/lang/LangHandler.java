...
public class LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("gtceu.multiblock.total_runs", "Performing %d Recipes Together");
        provider.add("gtceu.multiblock.batch_enabled", "- %dx from Batching");
        provider.add("gtceu.multiblock.subtick_parallels", "- %dx from Subtick Overclocking");
        ...
        provider.add("gtceu.multiblock.parallel.exact", "- %dx Parallels");
