...
public class LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("recipe.condition.ftb_quest.completed.tooltip", "Requires %s completed");
        provider.add("recipe.condition.ftb_quest.not_completed.tooltip", "Requires %s not completed");
