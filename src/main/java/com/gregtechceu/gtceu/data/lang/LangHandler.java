...
public class LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("behaviour.paintspray.solvent.tooltip", "§7Can remove color from things");
        provider.add("behaviour.paintspray.white.tooltip", "§7Can paint things in White");
        provider.add("behaviour.paintspray.orange.tooltip", "§7Can paint things in Orange");
        provider.add("behaviour.paintspray.magenta.tooltip", "§7Can paint things in Magenta");
        provider.add("behaviour.paintspray.light_blue.tooltip", "§7Can paint things in Light Blue");
        provider.add("behaviour.paintspray.yellow.tooltip", "§7Can paint things in Yellow");
        provider.add("behaviour.paintspray.lime.tooltip", "§7Can paint things in Lime");
        provider.add("behaviour.paintspray.pink.tooltip", "§7Can paint things in Pink");
        provider.add("behaviour.paintspray.gray.tooltip", "§7Can paint things in Gray");
        provider.add("behaviour.paintspray.light_gray.tooltip", "§7Can paint things in Light Gray");
        provider.add("behaviour.paintspray.cyan.tooltip", "§7Can paint things in Cyan");
        provider.add("behaviour.paintspray.purple.tooltip", "§7Can paint things in Purple");
        provider.add("behaviour.paintspray.blue.tooltip", "§7Can paint things in Blue");
        provider.add("behaviour.paintspray.brown.tooltip", "§7Can paint things in Brown");
        provider.add("behaviour.paintspray.green.tooltip", "§7Can paint things in Green");
        provider.add("behaviour.paintspray.red.tooltip", "§7Can paint things in Red");
        provider.add("behaviour.paintspray.black.tooltip", "§7Can paint things in Black");
        provider.add("behaviour.paintspray.uses", "§7Remaining Uses: %d");
        provider.add("behaviour.paintspray.offhand", "§7Hold in offhand to color while placing blocks");
