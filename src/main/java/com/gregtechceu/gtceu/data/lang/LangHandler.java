...
public class LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("cover.ender_fluid_link.tooltip.channel_description", "Channel description");
        provider.add("cover.ender_fluid_link.tooltip.channel_name", "Channel name");
