...
public abstract class ValueTransformer<T> {
    ...
    public record TransformerContext<U>(@NotNull ISyncManaged holder, @NotNull Class<U> clazz, @NotNull Type[] genericArgs, @Nullable U currentValue, boolean isClientSync) { }
