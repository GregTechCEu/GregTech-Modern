...
public class ElementMaterials {
    ...
    public static void register() {
        ...
        Chlorine = new Material.Builder(GTCEu.id("chlorine"))
                ...
                .hazard(HazardProperty.HazardType.INHALATION_POISON, new HazardProperty.HazardEffect(500, new MobEffectInstance(MobEffects.BLINDNESS, 1)), new HazardProperty.HazardDamage(2, 1), false)
                .buildAndRegister();
