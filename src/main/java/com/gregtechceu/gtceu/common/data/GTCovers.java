...
public class GTCovers {
    ...
    public final static RegistryObject<CoverDefinition> COVER_STORAGE = register("storage", StorageCover::new);

    public final static RegistryObject<CoverDefinition>[] CONVEYORS = registerTiered("conveyor", ConveyorCover::new,
    ...
    public final static RegistryObject<CoverDefinition>[] ROBOT_ARMS = registerTiered("robot_arm", RobotArmCover::new,
            () -> tier -> new IOCoverRenderer(
    ...
    public final static RegistryObject<CoverDefinition> WIRELESS_TRANSMITTER = register(
