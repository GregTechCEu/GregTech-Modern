...
public class GTMultiMachines {
    ...
    public static final MultiblockMachineDefinition COKE_OVEN = REGISTRATE.multiblock("coke_oven", CokeOvenMachine::new)
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .slice("XXX", "XYX", "XXX")
                    .where('X',
                            blocks(CASING_COKE_BRICKS.get()).and(blocks(COKE_OVEN_HATCH.get()).withMaxGlobalLimited(5)))
    ...
    public static final MultiblockMachineDefinition ELECTRIC_BLAST_FURNACE = REGISTRATE
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .where('X', blocks(CASING_INVAR_HEATPROOF.get()).withMinGlobalLimited(9)
    ...
    public static final MultiblockMachineDefinition LARGE_CHEMICAL_REACTOR = REGISTRATE
            ...
            .pattern(definition -> {
                var casing = blocks(CASING_PTFE_INERT.get()).withMinGlobalLimited(10);
                ...
                return MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                        ...
                        .where('C', Predicates.heatingCoils().withExactLimit(1)
                                .and(abilities)
                                .and(casing))
                        .build();
            })
    ...
    public static final MultiblockMachineDefinition IMPLOSION_COMPRESSOR = REGISTRATE
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .where('X', blocks(CASING_STEEL_SOLID.get()).withMinGlobalLimited(14)
    ...
    public static final MultiblockMachineDefinition PYROLYSE_OVEN = REGISTRATE
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .where('X',
                            blocks(MACHINE_CASING_ULV.get()).withMinGlobalLimited(6)
                                    .and(Predicates.autoAbilities(definition.getRecipeTypes()))
                                    .and(Predicates.autoAbilities(true, true, false)))
    ...
    public static final MultiblockMachineDefinition CRACKER = REGISTRATE
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .where('H', blocks(CASING_STAINLESS_CLEAN.get()).withMinGlobalLimited(12)
                            .and(Predicates.autoAbilities(definition.getRecipeTypes()))
                            .and(Predicates.autoAbilities(true, true, false)))
                    .where('#', Predicates.air())
                    .where('C', Predicates.heatingCoils())
    ...
    public static final MultiblockMachineDefinition DISTILLATION_TOWER = REGISTRATE
            ...
            .pattern(definition -> {
                ...
                exportPredicate = exportPredicate.withMaxLayerLimited(1);
                MultiPredicate maint = autoAbilities(true, false, false)
                        .withMaxGlobalLimited(1);
                return MultiblockPatternBuilder.start(UP, BACK, RIGHT)
                        ...
                        .where('Y', blocks(CASING_STAINLESS_CLEAN.get())
                                .and(Predicates.abilities(PartAbility.EXPORT_ITEMS).withMaxGlobalLimited(1))
                                .and(Predicates.abilities(PartAbility.INPUT_ENERGY).withMinGlobalLimited(1)
                                        .withMaxGlobalLimited(2))
                                .and(Predicates.abilities(PartAbility.IMPORT_FLUIDS).withExactLimit(1))
                                .and(maint))
    ...
    public static final MultiblockMachineDefinition VACUUM_FREEZER = REGISTRATE
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .slice("XXX", "XSX", "XXX")
                    .where('S', Predicates.controller(blocks(definition.getBlock())))
                    .where('X', blocks(CASING_ALUMINIUM_FROSTPROOF.get()).withMinGlobalLimited(14)
                            .and(Predicates.autoAbilities(definition.getRecipeTypes()))
                            .and(Predicates.autoAbilities(true, false, false)))
                    .where('#', Predicates.air())
                    .build())
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(RIGHT, UP, BACK)
                    ...
                    .where('F', blocks(CASING_STEEL_SOLID.get())
                            .and(!ConfigHolder.INSTANCE.machines.orderedAssemblyLineFluids ?
                                    ...
                                    Predicates.abilities(PartAbility.IMPORT_FLUIDS_1X).withMaxGlobalLimited(4)))
                    .where('O',
                    ...
                    .where('Y',
                            blocks(CASING_STEEL_SOLID.get()).and(Predicates.abilities(PartAbility.INPUT_ENERGY)
                                    .withMinGlobalLimited(1).withMaxGlobalLimited(2)))
    ...
    public static final MultiblockMachineDefinition STEAM_GRINDER = REGISTRATE
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .where('S', Predicates.controller(blocks(definition.getBlock())))
                    .where('#', Predicates.air())
                    .where('X', blocks(CASING_BRONZE_BRICKS.get()).withMinGlobalLimited(14)
                            .and(Predicates.abilities(PartAbility.STEAM_IMPORT_ITEMS).withPreviewCount(1))
                            .and(Predicates.abilities(PartAbility.STEAM_EXPORT_ITEMS).withPreviewCount(1))
                            .and(Predicates.abilities(PartAbility.STEAM).withExactLimit(1)))
                    .build())
    ...
    public static final MultiblockMachineDefinition STEAM_OVEN = REGISTRATE
            ...
            .pattern(definition -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .where('#', Predicates.air())
                    .where(' ', Predicates.any())
                    .where('X', blocks(CASING_BRONZE_BRICKS.get()).withMinGlobalLimited(6)
                            .and(Predicates.abilities(PartAbility.STEAM_IMPORT_ITEMS).withPreviewCount(1))
                            .and(Predicates.abilities(PartAbility.STEAM_EXPORT_ITEMS).withPreviewCount(1)))
    ...
    public static final MultiblockMachineDefinition[] FLUID_DRILLING_RIG = registerTieredMultis(REGISTRATE,
            "fluid_drilling_rig", FluidDrillMachine::new, (tier, builder) -> builder
                    ...
                    .pattern((definition) -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                            ...
                            .slice("XSX", "#F#", "#F#", "#F#", "###", "###", "###")
                            .where('S', controller(blocks(definition.get())))
                            .where('X', blocks(FluidDrillMachine.getCasingState(tier)).withMinGlobalLimited(3)
                                    .and(abilities(PartAbility.INPUT_ENERGY).withMinGlobalLimited(1)
                                            .withMaxGlobalLimited(2))
                                    .and(abilities(PartAbility.EXPORT_FLUIDS).withMaxGlobalLimited(1)))
            ...
            (tier, builder) -> builder
                    ...
                    .pattern((definition) -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                            ...
                            .where('X', blocks(LargeMinerMachine.getCasingState(tier))
                                    .and(abilities(PartAbility.EXPORT_ITEMS).withExactLimit(1).withPreviewCount(1))
                                    .and(abilities(PartAbility.IMPORT_FLUIDS).withExactLimit(1).withPreviewCount(1))
                                    .and(abilities(PartAbility.INPUT_ENERGY).withGlobalMinMax(1, 2).withPreviewCount(1)))
    ...
    public static final MultiblockMachineDefinition ACTIVE_TRANSFORMER = REGISTRATE
            ...
            .pattern((definition) -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                    ...
                    .slice("XXX", "XSX", "XXX")
                    .where('S', controller(blocks(definition.getBlock())))
                    .where('X', blocks(GTBlocks.HIGH_POWER_CASING.get()).withMinGlobalLimited(12)
    ...
    public static MultiblockMachineDefinition[] BEDROCK_ORE_MINER = registerTieredMultis(REGISTRATE,
            "bedrock_ore_miner", BedrockOreMinerMachine::new, (tier, builder) -> builder
                    ...
                    .pattern((definition) -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                            ...
                            .where('S', controller(blocks(definition.get())))
                            .where('X',
                                    blocks(BedrockOreMinerMachine.getCasingState(tier)).withMinGlobalLimited(3)
                                            .and(abilities(PartAbility.INPUT_ENERGY).withMinGlobalLimited(1)
                                                    .withMaxGlobalLimited(2))
                                            .and(abilities(PartAbility.EXPORT_ITEMS).withMaxGlobalLimited(1)))
