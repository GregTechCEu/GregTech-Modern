                        ...
                        return MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                                ...
                                .where('E', casing.and(
                                        blocks(PartAbility.INPUT_ENERGY.getBlockRange(tier, UV).toArray(Block[]::new))
                                                .withMinGlobalLimited(1).setPreviewCount(16)))
                                .where('C', casing)
            ...
            (tier, builder) -> builder
                    ...
                    .pattern((definition) -> MultiblockPatternBuilder.start(FRONT, UP, RIGHT)
                            ...
                            .where('X', blocks(LargeMinerMachine.getCasingState(tier))
                                    .and(abilities(PartAbility.EXPORT_ITEMS).withExactLimit(1).setPreviewCount(1))
                                    .and(abilities(PartAbility.IMPORT_FLUIDS).withExactLimit(1).setPreviewCount(1))
                                    .and(abilities(PartAbility.INPUT_ENERGY).withMinGlobalLimited(1)
                                            .withMaxGlobalLimited(2).setPreviewCount(1)))
