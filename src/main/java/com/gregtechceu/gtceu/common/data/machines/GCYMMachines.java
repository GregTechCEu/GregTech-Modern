    ...
    public final static MultiblockMachineDefinition LARGE_MIXER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('X', blocks(CASING_REACTION_SAFE.get()).setMinGlobalLimited(50)
                            ...
                            .or(Predicates.autoAbilities(true, false, true)))
                    .where('F', blocks(ChemicalHelper.getBlock(TagPrefix.FRAME_GT, GTMaterials.HastelloyX)))
    ...
    public final static MultiblockMachineDefinition MEGA_BLAST_FURNACE = REGISTRATE
            ...
            .pattern(definition -> {
                ...
                return FactoryBlockPattern.start()
                        ...
                        .where('C', heatingCoils())
                        .where('M', abilities(PartAbility.MUFFLER))
                        .where('F', blocks(ChemicalHelper.getBlock(TagPrefix.FRAME_GT, NaquadahAlloy)))
                        .where('H', casing)
            ...
            .shapeInfos(definition -> {
                ...
                var builder = MultiblockShapeInfo.builder()
                        ...
                        .where('F', ChemicalHelper.getBlock(TagPrefix.FRAME_GT, NaquadahAlloy))
