...
public class GTOreVeins {
    ...
    public static void updateLargestVeinSize(HolderLookup.RegistryLookup<GTOreDefinition> holderLookup) {
        // map to average of min & max values.
        GTOreVeins.largestVeinSize = holderLookup.listElements()
                .map(Holder::value)
        ...
        GTOreVeins.largestIndicatorOffset = holderLookup.listElements()
                .map(Holder::value)
