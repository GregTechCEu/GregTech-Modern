...
public class GTMachines {
    ...
    public static final MachineDefinition[] SUPER_CHEST = registerSuperChests(false, LOW_TIERS);
    public static final MachineDefinition[] QUANTUM_CHEST = registerSuperChests(true, HIGH_TIERS);
