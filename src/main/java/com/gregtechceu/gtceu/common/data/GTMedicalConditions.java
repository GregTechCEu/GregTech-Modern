...
public class GTMedicalConditions {
    ...
    // General Conditions
    public static final DeferredHolder<MedicalCondition, MedicalCondition> NONE = REGISTRATE.medicalCondition("none", 0xffffff, 0,
    ...
    public static final DeferredHolder<MedicalCondition, MedicalCondition> CHEMICAL_BURNS = REGISTRATE.medicalCondition("chemical_burns", 0xbc305a, 300,
    ...
    // heals 2 seconds' worth of progression every second when not holding those items
    public static final DeferredHolder<MedicalCondition, MedicalCondition> POISON = REGISTRATE.medicalCondition("poison", 0xA36300, 600,
            MedicalCondition.IdleProgressionType.HEAL, 2, true,
            builder -> builder.outputFluids(SulfurTrioxide.getFluid(1000)),
    ...
    public static final DeferredHolder<MedicalCondition, MedicalCondition> WEAK_POISON = REGISTRATE.medicalCondition("weak_poison", 0x6D7917, 1800,
            MedicalCondition.IdleProgressionType.NONE, 0, false,
            builder -> builder.outputFluids(NitricOxide.getFluid(1000)),
    ...
    public static final DeferredHolder<MedicalCondition, MedicalCondition> IRRITANT = REGISTRATE.medicalCondition("irritant", 0x02512f, 600,
            MedicalCondition.IdleProgressionType.HEAL, 5, false,
            builder -> builder.outputItems(dust, DarkAsh, 4),
    ...
    // heals 5 seconds' worth of progression every second when not holding those items
    public static final DeferredHolder<MedicalCondition, MedicalCondition> NAUSEA = REGISTRATE.medicalCondition("nausea", 0x1D4A00, 600,
            MedicalCondition.IdleProgressionType.HEAL, 5, false,
            builder -> builder.outputFluids(CarbonMonoxide.getFluid(50)),
     ...
     */
    public static final DeferredHolder<MedicalCondition, MedicalCondition> CARCINOGEN = REGISTRATE.medicalCondition("carcinogen", 0x0f570f, 36000,
    ...
    public static final DeferredHolder<MedicalCondition, MedicalCondition> ASBESTOSIS = REGISTRATE.medicalCondition("asbestosis", 0xe3e3e3, 5000,
            MedicalCondition.IdleProgressionType.HEAL, 1, true,
            builder -> builder.outputItems(dust, Asbestos, 4),
    ...
    public static final DeferredHolder<MedicalCondition, MedicalCondition> ARSENICOSIS = REGISTRATE.medicalCondition("arsenicosis", 0xbd4b15, 1000,
            MedicalCondition.IdleProgressionType.HEAL, 1, true,
            builder -> builder.outputItems(dust, Arsenic, 4),
    ...
    public static final DeferredHolder<MedicalCondition, MedicalCondition> METHANOL_POISONING = REGISTRATE.medicalCondition("methanol_poisoning", 0xaa8800, 600,
            MedicalCondition.IdleProgressionType.HEAL, .5f, true,
            builder -> builder.outputFluids(Methanol.getFluid(1000)),
    ...
    public static final DeferredHolder<MedicalCondition, MedicalCondition> CARBON_MONOXIDE_POISONING = REGISTRATE.medicalCondition("carbon_monoxide_poisoning",
            ...
            builder -> builder.outputFluids(CarbonMonoxide.getFluid(1000)),
            new Symptom.ConfiguredSymptom(Symptom.DEATH),
            new Symptom.ConfiguredSymptom(Symptom.NAUSEA),
