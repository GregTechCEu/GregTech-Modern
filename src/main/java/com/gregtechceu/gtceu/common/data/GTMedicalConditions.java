...
public class GTMedicalConditions {
    ...
    // heals 2 seconds' worth of progression every second when not holding those items
    public static final MedicalCondition POISON = REGISTRATE.medicalCondition("poison", 0xA36300, 600,
    ...
    public static final MedicalCondition WEAK_POISON = REGISTRATE.medicalCondition("weak_poison", 0x6D7917, 1800,
            MedicalCondition.IdleProgressionType.NONE, 0, false,
    ...
    public static final MedicalCondition IRRITANT = REGISTRATE.medicalCondition("irritant", 0x02512f, 600,
     ...
     */
    public static final MedicalCondition CARCINOGEN = REGISTRATE.medicalCondition("carcinogen",
            0x0f570f, 36000,
    ...
    public static final MedicalCondition ASBESTOSIS = REGISTRATE.medicalCondition("asbestosis", 0xe3e3e3, 5000,
    ...
    public static final MedicalCondition ARSENICOSIS = REGISTRATE.medicalCondition("arsenicosis", 0xbd4b15, 1000,
            MedicalCondition.IdleProgressionType.HEAL, 1, true,
