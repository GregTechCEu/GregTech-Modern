...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        AnnealedCopper = REGISTRATE.material("annealed_copper")
                ...
                .onRegister(mat -> {
                    Copper.get().getProperty(PropertyKey.INGOT).setArcSmeltingInto(mat);
                })
                .register();
        ...
        WroughtIron = REGISTRATE.material("wrought_iron")
                ...
                .onRegister(mat -> {
                    IngotProperty iron = Iron.get().getProperty(PropertyKey.INGOT);
                    iron.setSmeltingInto(mat);
                    iron.setArcSmeltingInto(mat);
                })
                .register();
        ...
        NeodymiumMagnetic = REGISTRATE.material("magnetic_neodymium")
                ...
                .onRegister(mat -> {
                    IngotProperty neodymium = Neodymium.get().getProperty(PropertyKey.INGOT);
                    neodymium.setMagneticMaterial(mat);
                })
                .register();
        ...
        SamariumMagnetic = REGISTRATE.material("magnetic_samarium")
                ...
                .onRegister(mat -> {
                    IngotProperty samarium = Samarium.get().getProperty(PropertyKey.INGOT);
                    samarium.setMagneticMaterial(mat);
                })
                .register();
