...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        NiobiumTitanium = new Material.Builder(GTCEu.id("niobium_titanium"))
                ...
                .appendFlags(EXT2_METAL, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FOIL,
                        GENERATE_FINE_WIRE)
        ...
        YttriumBariumCuprate = new Material.Builder(GTCEu.id("yttrium_barium_cuprate"))
                ...
                .appendFlags(EXT_METAL, GENERATE_FINE_WIRE, GENERATE_SPRING, GENERATE_SPRING_SMALL,
                        GENERATE_FOIL,
                        GENERATE_BOLT_SCREW)
