...
import static com.gregtechceu.gtceu.api.recipe.GTRecipeType.ProgressBarDirection.*;
...
public class GTRecipeTypes {
    ...
    public final static GTRecipeType STEAM_BOILER_RECIPES = register("steam_boiler", STEAM)
            ...
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_BOILER_FUEL_HP, DOWN_TO_UP)
            .setMaxTooltips(1)
    ...
    public final static GTRecipeType FURNACE_RECIPES = register("electric_furnace", ELECTRIC, RecipeType.SMELTING)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::FURNACE_OVERLAY_1)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
            .setSteamProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW_STEAM, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.FURNACE);
    ...
    public final static GTRecipeType ARC_FURNACE_RECIPES = register("arc_furnace", ELECTRIC).setMaxIOSize(1, 4, 1, 1)
            .setEUIO(IO.IN)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARC_FURNACE, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType ASSEMBLER_RECIPES = register("assembler", ELECTRIC).setMaxIOSize(9, 1, 1, 0)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::SLOT)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ASSEMBLER, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.ASSEMBLER);

    public final static GTRecipeType AUTOCLAVE_RECIPES = register("autoclave", ELECTRIC).setMaxIOSize(2, 2, 1, 1)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::DUST_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::CRYSTAL_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_CRYSTALLIZATION, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.FURNACE);

    public final static GTRecipeType BENDER_RECIPES = register("bender", ELECTRIC).setMaxIOSize(2, 1, 0, 0)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, false, GTRecipeTypeTextures::BENDER_OVERLAY)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::INT_CIRCUIT_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_BENDING, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType BREWING_RECIPES = register("brewery", ELECTRIC).setMaxIOSize(1, 0, 1, 1)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::BREWER_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW_MULTIPLE, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType MACERATOR_RECIPES = register("macerator", ELECTRIC).setMaxIOSize(1, 4, 0, 0)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::CRUSHED_ORE_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::DUST_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_MACERATE, LEFT_TO_RIGHT)
            .setIconSupplier(() -> GTMachines.MACERATOR[GTValues.LV].asStack())
            .setSteamProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_MACERATE_STEAM, LEFT_TO_RIGHT)
            .addCustomRecipeLogic(MaceratorLogic.INSTANCE)
            .setSound(GTSoundEntries.MACERATOR)
            .addDataInfo(data -> I18n.get("gtceu.recipe.byproduct_tier", GTValues.VNF[GTValues.HV]));

    public final static GTRecipeType CANNER_RECIPES = register("canner", ELECTRIC).setMaxIOSize(2, 2, 1, 1)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, false, GTRecipeTypeTextures::CANNER_OVERLAY)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::CANISTER_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::CANISTER_OVERLAY)
            .setSlotOverlay(false, true, GTRecipeTypeTextures::DARK_CANISTER_OVERLAY)
            .setSlotOverlay(true, true, GTRecipeTypeTextures::DARK_CANISTER_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_CANNER, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType CENTRIFUGE_RECIPES = register("centrifuge", ELECTRIC).setMaxIOSize(2, 6, 1, 6)
            ...
            .setSlotOverlay(false, false, false, GTRecipeTypeTextures::EXTRACTOR_OVERLAY)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::CANISTER_OVERLAY)
            .setSlotOverlay(false, true, true, GTRecipeTypeTextures::CENTRIFUGE_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_EXTRACT, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType CHEMICAL_BATH_RECIPES = register("chemical_bath", ELECTRIC)
            ...
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::BREWER_OVERLAY)
            .setSlotOverlay(true, false, false, GTRecipeTypeTextures::DUST_OVERLAY)
            .setSlotOverlay(true, false, true, GTRecipeTypeTextures::DUST_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_MIXER, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.BATH);

    public final static GTRecipeType CHEMICAL_RECIPES = register("chemical_reactor", ELECTRIC).setMaxIOSize(2, 2, 3, 2)
            .setEUIO(IO.IN)
            .prepareBuilder(recipeBuilder -> recipeBuilder.EUt(GTValues.VA[GTValues.LV]))
            .setSlotOverlay(false, false, false, GTRecipeTypeTextures::MOLECULAR_OVERLAY_1)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::MOLECULAR_OVERLAY_2)
            .setSlotOverlay(false, true, false, GTRecipeTypeTextures::MOLECULAR_OVERLAY_3)
            .setSlotOverlay(false, true, true, GTRecipeTypeTextures::MOLECULAR_OVERLAY_4)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::VIAL_OVERLAY_1)
            .setSlotOverlay(true, true, GTRecipeTypeTextures::VIAL_OVERLAY_2)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW_MULTIPLE, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType COMPRESSOR_RECIPES = register("compressor", ELECTRIC).setMaxIOSize(1, 1, 0, 0)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::COMPRESSOR_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_COMPRESS, LEFT_TO_RIGHT)
            .setIconSupplier(() -> GTMachines.COMPRESSOR[GTValues.LV].asStack())
            .setSteamProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_COMPRESS_STEAM, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.COMPRESSOR);

    public final static GTRecipeType CUTTER_RECIPES = register("cutter", ELECTRIC).setMaxIOSize(1, 2, 1, 0)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::SAWBLADE_OVERLAY)
            .setSlotOverlay(true, false, false, GTRecipeTypeTextures::CUTTER_OVERLAY)
            .setSlotOverlay(true, false, true, GTRecipeTypeTextures::DUST_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_SLICE, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType DISTILLERY_RECIPES = register("distillery", ELECTRIC).setMaxIOSize(1, 1, 1, 1)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, true, GTRecipeTypeTextures::BEAKER_OVERLAY_1)
            .setSlotOverlay(true, true, GTRecipeTypeTextures::BEAKER_OVERLAY_4)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::DUST_OVERLAY)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::INT_CIRCUIT_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW_MULTIPLE, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.BOILER);

    public final static GTRecipeType ELECTROLYZER_RECIPES = register("electrolyzer", ELECTRIC).setMaxIOSize(2, 6, 1, 6)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, false, GTRecipeTypeTextures::LIGHTNING_OVERLAY_1)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::CANISTER_OVERLAY)
            .setSlotOverlay(false, true, true, GTRecipeTypeTextures::LIGHTNING_OVERLAY_2)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_EXTRACT, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType ELECTROMAGNETIC_SEPARATOR_RECIPES = register("electromagnetic_separator", ELECTRIC)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::CRUSHED_ORE_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::DUST_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_MAGNET, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.ARC);
    ...
    public final static GTRecipeType EXTRACTOR_RECIPES = register("extractor", ELECTRIC).setMaxIOSize(1, 1, 0, 1)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::EXTRACTOR_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_EXTRACT, LEFT_TO_RIGHT)
            .setIconSupplier(() -> GTMachines.EXTRACTOR[GTValues.LV].asStack())
            .setSteamProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_EXTRACT_STEAM, LEFT_TO_RIGHT);

    public final static GTRecipeType EXTRUDER_RECIPES = register("extruder", ELECTRIC).setMaxIOSize(2, 1, 0, 0)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::MOLD_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_EXTRUDER, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.COMPRESSOR);
    ...
    public final static GTRecipeType FERMENTING_RECIPES = register("fermenter", ELECTRIC).setMaxIOSize(1, 1, 1, 1)
            ...
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::DUST_OVERLAY)
            .setSlotOverlay(true, false, true, GTRecipeTypeTextures::DUST_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.CHEMICAL);
    ...
    public final static GTRecipeType FLUID_HEATER_RECIPES = register("fluid_heater", ELECTRIC).setMaxIOSize(1, 0, 1, 1)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, true, GTRecipeTypeTextures::HEATING_OVERLAY_1)
            .setSlotOverlay(true, true, GTRecipeTypeTextures::HEATING_OVERLAY_2)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::INT_CIRCUIT_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.BOILER);
    ...
    public final static GTRecipeType FLUID_SOLIDFICATION_RECIPES = register("fluid_solidifier", ELECTRIC)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::SOLIDIFIER_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.COOLING);

    public final static GTRecipeType FORGE_HAMMER_RECIPES = register("forge_hammer", ELECTRIC).setMaxIOSize(1, 1, 0, 0)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::HAMMER_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_HAMMER, UP_TO_DOWN)
            .setIconSupplier(() -> GTMachines.FORGE_HAMMER[GTValues.LV].asStack())
            .setSteamProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_HAMMER_STEAM, UP_TO_DOWN)
    ...
    public final static GTRecipeType LATHE_RECIPES = register("lathe", ELECTRIC).setMaxIOSize(1, 2, 0, 0).setEUIO(IO.IN)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::PIPE_OVERLAY_1)
            .setSlotOverlay(true, false, false, GTRecipeTypeTextures::PIPE_OVERLAY_2)
            .setSlotOverlay(true, false, true, GTRecipeTypeTextures::DUST_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_LATHE, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.CUT);
    ...
    public final static GTRecipeType ORE_WASHER_RECIPES = register("ore_washer", ELECTRIC).setMaxIOSize(2, 3, 1, 0)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::CRUSHED_ORE_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::DUST_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_BATH, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.BATH);
    ...
    public final static GTRecipeType PACKER_RECIPES = register("packer", ELECTRIC).setMaxIOSize(2, 2, 0, 0)
            ...
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::BOX_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::BOXED_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_UNPACKER, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.ASSEMBLER);
    ...
    public final static GTRecipeType LASER_ENGRAVER_RECIPES = register("laser_engraver", ELECTRIC)
            .setMaxIOSize(2, 1, 0, 0).setEUIO(IO.IN)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::LENS_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.ELECTROLYZER);

    public final static GTRecipeType SIFTER_RECIPES = register("sifter", ELECTRIC).setMaxIOSize(1, 6, 0, 0)
            .setEUIO(IO.IN)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_SIFT, UP_TO_DOWN)
    ...
    public final static GTRecipeType WIREMILL_RECIPES = register("wiremill", ELECTRIC).setMaxIOSize(2, 1, 0, 0)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::WIREMILL_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_WIREMILL, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.MOTOR);
    ...
    public final static GTRecipeType CIRCUIT_ASSEMBLER_RECIPES = register("circuit_assembler", ELECTRIC)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::CIRCUIT_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_CIRCUIT_ASSEMBLER, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.ASSEMBLER)
            .onRecipeBuild((recipeBuilder, provider) -> {
                if (recipeBuilder.input.getOrDefault(FluidRecipeCapability.CAP, Collections.emptyList()).isEmpty() &&
                        recipeBuilder.tickInput.getOrDefault(FluidRecipeCapability.CAP, Collections.emptyList())
    ...
    public final static GTRecipeType GAS_COLLECTOR_RECIPES = register("gas_collector", ELECTRIC)
            ...
            .setSlotOverlay(false, false, GTRecipeTypeTextures::INT_CIRCUIT_OVERLAY)
            .setSlotOverlay(true, true, GTRecipeTypeTextures::CENTRIFUGE_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_GAS_COLLECTOR, LEFT_TO_RIGHT)
    ...
    public static final GTRecipeType RESEARCH_STATION_RECIPES = register("research_station", ELECTRIC)
            ...
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::SCANNER_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::RESEARCH_STATION_OVERLAY)
            .setScanner(true)
            .setMaxTooltips(4)
    ...
    public final static GTRecipeType ROCK_BREAKER_RECIPES = register("rock_breaker", ELECTRIC).setMaxIOSize(1, 4, 0, 0)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::DUST_OVERLAY)
            .setSlotOverlay(true, false, GTRecipeTypeTextures::CRUSHED_ORE_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_MACERATE, LEFT_TO_RIGHT)
            .setIconSupplier(() -> GTMachines.ROCK_CRUSHER[GTValues.LV].asStack())
            .setSteamProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_MACERATE_STEAM, LEFT_TO_RIGHT)
            .setUiBuilder((recipe, widgetGroup) -> GTRecipeTypeUIBuilders.addRockBreakerFluidSlots(recipe,
                    widgetGroup))
            .setSound(GTSoundEntries.FIRE);

    public static final GTRecipeType SCANNER_RECIPES = register("scanner", ELECTRIC)
            .setMaxIOSize(2, 1, 1, 0)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::DATA_ORB_OVERLAY)
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::SCANNER_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType GAS_TURBINE_FUELS = register("gas_turbine", GENERATOR).setMaxIOSize(0, 0, 1, 0)
            .setEUIO(IO.OUT)
            .setSlotOverlay(false, true, true, GTRecipeTypeTextures::DARK_CANISTER_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_GAS_COLLECTOR, LEFT_TO_RIGHT)
    ...
    public final static GTRecipeType BLAST_RECIPES = register("electric_blast_furnace", MULTIBLOCK)
            ...
            .setUiBuilder((recipe, widgetGroup) -> GTRecipeTypeUIBuilders.addElectricBlastFurnaceCoilSlot(recipe,
                    widgetGroup))
            .setSound(GTSoundEntries.FURNACE);
    ...
    public final static GTRecipeType DISTILLATION_RECIPES = register("distillation_tower", MULTIBLOCK)
            ...
            .onRecipeBuild((recipeBuilder, provider) -> {
                ...
                if (recipeBuilder.output.containsKey(FluidRecipeCapability.CAP)) {
                    ...
                    if (input.ingredient().fluids().isEmpty()) return;
                    ...
                    for (int i = 0; i < contents.size(); ++i) {
                        ...
                        if (output.ingredient().fluids().isEmpty()) continue;
    ...
    public final static GTRecipeType CRACKING_RECIPES = register("cracker", MULTIBLOCK).setMaxIOSize(1, 0, 2, 2)
            .setEUIO(IO.IN)
            .setSlotOverlay(false, true, GTRecipeTypeTextures::CRACKING_OVERLAY_1)
            .setSlotOverlay(true, true, GTRecipeTypeTextures::CRACKING_OVERLAY_2)
            .setSlotOverlay(false, false, GTRecipeTypeTextures::CIRCUIT_OVERLAY)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_CRACKING, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.FIRE);
    ...
    public final static GTRecipeType IMPLOSION_RECIPES = register("implosion_compressor", MULTIBLOCK)
            ...
            .setSlotOverlay(false, false, true, GTRecipeTypeTextures::IMPLOSION_OVERLAY_1)
            .setSlotOverlay(false, false, false, GTRecipeTypeTextures::IMPLOSION_OVERLAY_2)
            .setSlotOverlay(true, false, true, GTRecipeTypeTextures::DUST_OVERLAY)
    ...
    public static final GTRecipeType FUSION_RECIPES = register("fusion_reactor", MULTIBLOCK).setMaxIOSize(0, 0, 2, 1)
            .setEUIO(IO.IN)
            .setProgressBar(GTRecipeTypeTextures::PROGRESS_BAR_FUSION, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.ARC)
            .setOffsetVoltageText(true)
            .setMaxTooltips(4)
            .setUiBuilder((recipe, widgetGroup) -> GTRecipeTypeUIBuilders.addFusionEUToStartLabel(recipe,
                    widgetGroup));
    ...
    public static GTRecipeType register(String name, String group, RecipeType<?>... proxyRecipes) {
        ...
        recipeType.setSerializer(GTRegistries.register(BuiltInRegistries.RECIPE_SERIALIZER, recipeType.registryName,
                new RecipeSerializer<>(GTRecipeSerializer.CODEC, GTRecipeSerializer.STREAM_CODEC)));
        return recipeType;
    }
    ...
    public @Nullable static GTRecipeType get(String name) {
        RecipeType<?> type = BuiltInRegistries.RECIPE_TYPE.getValue(GTCEu.id(name));
