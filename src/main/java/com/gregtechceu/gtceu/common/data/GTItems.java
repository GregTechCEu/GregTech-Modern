...
public class GTItems {
    ...
    public static ItemEntry<ArmorComponentItem> NIGHTVISION_GOGGLES = REGISTRATE.item("nightvision_goggles", (p) -> new ArmorComponentItem(GTArmorMaterials.GOGGLES, EquipmentSlot.HEAD, p)
            .setArmorLogic(new NightvisionGoggles(2,
                ...
                ConfigHolder.INSTANCE.tools.voltageTierNightVision, EquipmentSlot.HEAD)))
        .lang("Nightvision Goggles")
        .register();

    public static ItemEntry<ArmorComponentItem> NANO_CHESTPLATE = REGISTRATE.item("nanomuscle_chestplate", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.CHEST, p)
            .setArmorLogic(new NanoMuscleSuite(EquipmentSlot.CHEST,
                512,
        ...
        .register();
    public static ItemEntry<ArmorComponentItem> NANO_LEGGINGS = REGISTRATE.item("nanomuscle_leggings", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.LEGS, p)
            .setArmorLogic(new NanoMuscleSuite(EquipmentSlot.LEGS,
                512,
                6_400_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.INSTANCE.tools.voltageTierNanoSuit - 3)),
                ConfigHolder.INSTANCE.tools.voltageTierNanoSuit)))
        ...
        .properties(p -> p.rarity(Rarity.UNCOMMON))
        .register();
    public static ItemEntry<ArmorComponentItem> NANO_BOOTS = REGISTRATE.item("nanomuscle_boots", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.FEET, p)
            .setArmorLogic(new NanoMuscleSuite(EquipmentSlot.FEET,
                512,
                6_400_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.INSTANCE.tools.voltageTierNanoSuit - 3)),
                ConfigHolder.INSTANCE.tools.voltageTierNanoSuit)))
        ...
        .properties(p -> p.rarity(Rarity.UNCOMMON))
        .register();
    public static ItemEntry<ArmorComponentItem> NANO_HELMET = REGISTRATE.item("nanomuscle_helmet", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.HEAD, p)
            .setArmorLogic(new NanoMuscleSuite(EquipmentSlot.HEAD,
                512,
                6_400_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.INSTANCE.tools.voltageTierNanoSuit - 3)),
                ConfigHolder.INSTANCE.tools.voltageTierNanoSuit)))
    ...
    public static ItemEntry<ArmorComponentItem> QUANTUM_CHESTPLATE = REGISTRATE.item("quarktech_chestplate", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.CHEST, p)
            .setArmorLogic(new QuarkTechSuite(EquipmentSlot.CHEST,
                8192,
        ...
        .register();
    public static ItemEntry<ArmorComponentItem> QUANTUM_LEGGINGS = REGISTRATE.item("quarktech_leggings", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.LEGS, p)
            .setArmorLogic(new QuarkTechSuite(EquipmentSlot.LEGS,
                8192,
                100_000_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.INSTANCE.tools.voltageTierQuarkTech - 5)),
                ConfigHolder.INSTANCE.tools.voltageTierQuarkTech)))
        ...
        .properties(p -> p.rarity(Rarity.RARE))
        .register();
    public static ItemEntry<ArmorComponentItem> QUANTUM_BOOTS = REGISTRATE.item("quarktech_boots", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.FEET, p)
            .setArmorLogic(new QuarkTechSuite(EquipmentSlot.FEET,
                8192,
                100_000_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.INSTANCE.tools.voltageTierQuarkTech - 5)),
                ConfigHolder.INSTANCE.tools.voltageTierQuarkTech)))
        .lang("QuarkTech™ Suite Leggings")
        .properties(p -> p.rarity(Rarity.RARE))
        .register();
    public static ItemEntry<ArmorComponentItem> QUANTUM_HELMET = REGISTRATE.item("quarktech_helmet", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.HEAD, p)
            .setArmorLogic(new QuarkTechSuite(EquipmentSlot.HEAD,
                8192,
                100_000_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.INSTANCE.tools.voltageTierQuarkTech - 5)),
                ConfigHolder.INSTANCE.tools.voltageTierQuarkTech)))
    ...
    public static ItemEntry<ArmorComponentItem> LIQUID_FUEL_JETPACK = REGISTRATE.item("liquid_fuel_jetpack", (p) -> new ArmorComponentItem(GTArmorMaterials.JETPACK, EquipmentSlot.CHEST, p)
            .setArmorLogic(new PowerlessJetpack()))
        .lang("Liquid Fuel Jetpack")
        .setData(ProviderType.ITEM_MODEL, NonNullBiConsumer.noop())
        .register();
    public static ItemEntry<ArmorComponentItem> ELECTRIC_JETPACK = REGISTRATE.item("electric_jetpack", (p) -> new ArmorComponentItem(GTArmorMaterials.JETPACK, EquipmentSlot.CHEST, p)
    ...
    public static ItemEntry<ArmorComponentItem> ELECTRIC_JETPACK_ADVANCED = REGISTRATE.item("advanced_electric_jetpack", (p) -> new ArmorComponentItem(GTArmorMaterials.JETPACK, EquipmentSlot.CHEST, p)
        ...
        .properties(p -> p.rarity(Rarity.RARE))
        .register();
    public static ItemEntry<ArmorComponentItem> NANO_CHESTPLATE_ADVANCED = REGISTRATE.item("avanced_nanomuscle_chestplate", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.CHEST, p)
        ...
        .properties(p -> p.rarity(Rarity.RARE))
        .register();
    public static ItemEntry<ArmorComponentItem> QUANTUM_CHESTPLATE_ADVANCED = REGISTRATE.item("advanced_quarktech_chestplate", (p) -> new ArmorComponentItem(GTArmorMaterials.ARMOR, EquipmentSlot.CHEST, p)
