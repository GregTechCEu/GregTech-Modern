...
public class GTItems {
    ...
    public static ItemEntry<Item> PIPENET_DEBUG_VIEWER = REGISTRATE.item("pipenet_debug_viewer", Item::new)
            .lang("Pipenet Debug Viewer").properties(p -> p.stacksTo(1)).register();
