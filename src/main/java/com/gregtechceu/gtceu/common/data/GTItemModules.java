...
public class GTItemModules {
    ...
    public static final ItemModule LIQUID_FUEL_JETPACK = register(GTCEu.id("liquid_fuel_jetpack"),
            LiquidFuelJetpackModule::new);
    public static final ItemModule JETPACK = register(GTCEu.id("jetpack"), JetpackModule::new);
    public static final ItemModule ADVANCED_JETPACK = register(GTCEu.id("advanced_jetpack"),
            AdvancedJetpackModule::new);
