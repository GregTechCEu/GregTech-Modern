...
public class GTItemModules {
    ...
    public static final ItemModule[] DAMAGE_BLOCK = registerTiered(GTCEu.id("damage_block"),
            EnergyShieldItemModule::new);
    public static final ItemModule[] ATTACK_SPEED = registerTiered(GTCEu.id("attack_speed"),
            AttackSpeedItemModule::new);
    public static final ItemModule[] ATTACK_DAMAGE = registerTiered(GTCEu.id("attack_damage"),
            AttackDamageItemModule::new);
    public static final ItemModule[] BLOCK_REACH = registerTiered(GTCEu.id("block_reach"),
            BlockReachItemModule::new);
    public static final ItemModule[] MOVEMENT_SPEED_ATTR = registerTiered(GTCEu.id("movement_speed"),
            MovementSpeedItemModule::new);
    public static final ItemModule[] SNEAK_SPEED = registerTiered(GTCEu.id("sneak_speed"),
            SneakSpeedItemModule::new);
    public static final ItemModule[] SWIM_SPEED = registerTiered(GTCEu.id("swim_speed"), SwimSpeedModule::new);
    public static final ItemModule[] STEP_HEIGHT = registerTiered(GTCEu.id("step_height"),
            StepHeightModule::new);
    public static final ItemModule[] JUMP_BOOST = registerTiered(GTCEu.id("jump_boost"),
            JumpBoostItemModule::new);
    public static final ItemModule[] SENSOR = registerTiered(GTCEu.id("sensor"), SensorItemModule::new);
    public static final ItemModule[] WIRELESS_CHARGER = registerTiered(GTCEu.id("wireless_charger"),
    ...
    public static TieredItemModule[] registerTiered(ResourceLocation id,
                                                    BiFunction<ResourceLocation, Integer, TieredItemModule> constructor) {
        return registerTiered(id, constructor, GTValues.tiersBetween(GTValues.OpV, GTValues.MAX));
    }
