...
public class GTPlacerTypes {
    ...
    public static <P extends TrunkPlacer> TrunkPlacerType<P> registerTruckPlacer(String pKey, MapCodec<P> pCodec) {
        return GTRegistries.register(BuiltInRegistries.TRUNK_PLACER_TYPE, GTCEu.id(pKey), ITrunkPlacerTypeAccessor.callCtor(pCodec));
    }

    public static <P extends FoliagePlacer> FoliagePlacerType<P> registerFoliagePlacer(String pKey, MapCodec<P> pCodec) {
