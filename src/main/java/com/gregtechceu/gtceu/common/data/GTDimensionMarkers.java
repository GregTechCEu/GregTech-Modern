...
public class GTDimensionMarkers {
    ...
    public static final DeferredHolder<DimensionMarker, DimensionMarker> OVERWORLD = DIMENSION_MARKER.register(
            "overworld",
            () -> new DimensionMarker(Level.OVERWORLD, 0,
                    () -> OVERWORLD_MARKER, null));

    public static final DeferredHolder<DimensionMarker, DimensionMarker> NETHER = DIMENSION_MARKER.register("nether",
            () -> new DimensionMarker(Level.NETHER, 0,
                    () -> NETHER_MARKER, null));

    public static final DeferredHolder<DimensionMarker, DimensionMarker> END = DIMENSION_MARKER.register("end",
