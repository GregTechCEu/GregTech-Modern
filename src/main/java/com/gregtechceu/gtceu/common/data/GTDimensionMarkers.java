...
public class GTDimensionMarkers {
    ...
    private static final DeferredRegister<DimensionMarker> BASE_MC_DIMENSION_MARKERS = DeferredRegister
            .create(GTRegistries.Keys.DIMENSION_MARKER, "minecraft");
    ...
    public static final Holder<DimensionMarker> OVERWORLD = BASE_MC_DIMENSION_MARKERS.register("overworld",
            () -> new DimensionMarker(0, () -> OVERWORLD_MARKER, null));
    public static final Holder<DimensionMarker> NETHER = BASE_MC_DIMENSION_MARKERS.register("nether",
            () -> new DimensionMarker(0, () -> NETHER_MARKER, null));
    public static final Holder<DimensionMarker> END = BASE_MC_DIMENSION_MARKERS.register("end",
            () -> new DimensionMarker(0, () -> END_MARKER, null));
