...
public class ResolvableItemEnchantments implements TooltipProvider {
    ...
    // spotless:off
    public static final ResolvableItemEnchantments EMPTY = new ResolvableItemEnchantments(new Object2IntOpenHashMap<>(), true);
    ...
    private static final Codec<Object2IntOpenHashMap<EitherHolder<Enchantment>>> LEVELS_CODEC = Codec.unboundedMap(ENCHANTMENT_CODEC, LEVEL_CODEC)
    ...
    private static final Codec<ResolvableItemEnchantments> FULL_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.BOOL.optionalFieldOf("show_in_tooltip", Boolean.TRUE).forGetter(enchantments -> enchantments.showInTooltip)
    ...
    private static final StreamCodec<RegistryFriendlyByteBuf, Object2IntOpenHashMap<EitherHolder<Enchantment>>> LEVELS_STREAM_CODEC = ByteBufCodecs.map(
    ...
    private final Object2IntOpenHashMap<EitherHolder<Enchantment>> enchantments;
    private final boolean showInTooltip;

    ResolvableItemEnchantments(Object2IntOpenHashMap<EitherHolder<Enchantment>> enchantments, boolean showInTooltip) {
    ...
    public void addToTooltip(Item.TooltipContext context, Consumer<Component> tooltipAdder, TooltipFlag tooltipFlag) {
        if (this.showInTooltip) {
            ...
            for (Holder<Enchantment> enchantment : tooltipOrder) {
                int i = this.enchantments.getInt(enchantment);
                if (i > 0) {
    ...
    public static class Mutable {
        private final Object2IntOpenHashMap<EitherHolder<Enchantment>> enchantments = new Object2IntOpenHashMap<>();
        private final boolean showInTooltip;
