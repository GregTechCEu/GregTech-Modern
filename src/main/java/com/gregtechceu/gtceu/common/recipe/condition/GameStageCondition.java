...
public class GameStageCondition extends RecipeCondition<GameStageCondition> {
    ...
    public Component getTooltips() {
        if (isReverse) return Component.translatable("recipe.gtceu.condition.gamestage.locked_stage", stageName);
        return Component.translatable("recipe.gtceu.condition.gamestage.unlocked_stage", stageName);
    }
