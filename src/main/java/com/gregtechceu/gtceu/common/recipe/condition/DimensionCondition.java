...
public class DimensionCondition extends RecipeCondition<DimensionCondition> {
    ...
    public Component getTooltips() {
        return Component.translatable("recipe_condition.gtceu.dimension.tooltip", dimension);
    }
    ...
    public RecipeUIModifier modifyUI() {
        return (recipe, widget) -> {
            ...
            dimConditionRow.child(Text.lang("recipe_condition.gtceu.dimension.tooltip", "").asWidget());
