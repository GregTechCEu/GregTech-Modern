...
public class CleanroomCondition extends RecipeCondition<CleanroomCondition> {
    ...
    public Component getTooltips() {
        return cleanroom == null ? null :
                Component.translatable("recipe_condition.gtceu.cleanroom",
                        Component.translatable(cleanroom.getTranslationKey()));
    }
    ...
    public boolean testCondition(@NotNull GTRecipe recipe, @NotNull RecipeLogic recipeLogic) {
        ...
        CleanroomReceiverTrait receiverTrait = machine.getTrait(CleanroomReceiverTrait.class);
