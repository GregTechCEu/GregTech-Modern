...
public class AdjacentFluidCondition extends RecipeCondition<AdjacentFluidCondition> {
    ...
    public Component getTooltips() {
        var tooltips = Component.translatable("recipe.gtceu.condition.adjacent_fluid.tooltip");
        fluids.forEach(set -> {
    ...
    public RecipeUIModifier modifyUI() {
        return (recipe, widget) -> {
            ...
            row.child(Text.lang("recipe.gtceu.condition.adjacent_fluid.tooltip").asWidget());
