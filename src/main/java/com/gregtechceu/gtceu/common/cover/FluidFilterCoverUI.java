...
final class FluidFilterCoverUI {

    private FluidFilterCoverUI() {}

    static Widget createUIWidget(FluidFilterCover cover) {
        ...
        group.addWidget((Widget) cover.getFluidFilter().openConfigurator(62, 25));
        return group;
    }
}
