...
public class AdvancedFluidDetectorCover extends FluidDetectorCover implements IUICover {
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new LabelWidget(10, 5, "advanced_fluid_detector.label"));

        group.addWidget(new TextBoxWidget(10, 55, 65,
                List.of(LocalizationUtils.format("advanced_fluid_detector.min"))));

        group.addWidget(new TextBoxWidget(10, 80, 65,
                List.of(LocalizationUtils.format("advanced_fluid_detector.max"))));
        ...
        group.addWidget(new ToggleButtonWidget(
                ...
                .isMultiLang()
                .setTooltipText("advanced_fluid_detector.invert"));
