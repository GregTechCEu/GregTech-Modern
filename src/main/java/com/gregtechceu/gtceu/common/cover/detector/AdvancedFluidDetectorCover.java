    ...
    public void createCoverUIRows(Flow column, SidedPosGuiData data, PanelSyncManager syncManager,
        ...
        var buttonRow = coverUIRow()
                .child(new ToggleButton().value(new BooleanSyncValue(this::isInverted, this::setInverted))
                        ...
                        .tooltip(false, t -> t.add("cover.gtceu.advanced_fluid_detector.invert.disabled"))
                        .tooltip(true, t -> t.add("cover.gtceu.advanced_fluid_detector.invert.enabled")))
        ...
        column.child(coverUIRow().child(Text.lang("cover.gtceu.advanced_fluid_detector.min").asWidget().width(50))
                .child(GTMuiWidgets.createIntInputWithButtons(minValueSync, () -> 0, this::getMaxValue).width(110)))
                .child(coverUIRow().child(Text.lang("cover.gtceu.advanced_fluid_detector.max").asWidget().width(50))
