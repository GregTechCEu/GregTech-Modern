...
// return tank == 0 ? net.getNodeAt(pipe.getPipePos()).data.properties.getPlatformThroughput() -
// net.getThroughputUsed(pipe.getPipePos()) : 0;
// }
//
// @Override
...
// * @return amount
// */
// private long checkPathAvailable(FluidStack stack, PipeNetRoutePath routePath, Map<BlockPos, Set<Fluid>>
// simulateChannelUsed, Object2LongMap<BlockPos> simulateThroughputUsed) {
...
//
// var left = properties.getPlatformThroughput() - net.getThroughputUsed(pos) - simulateThroughputUsed.getOrDefault(pos,
// 0);
...
// if (coverable != null) {
// if (coverable.getCoverAtSide(path.getFaceToHandler()) instanceof FluidFilterCover cover &&
// !cover.getFluidFilter().test(resource)) {
// return 0;
// }
// }
