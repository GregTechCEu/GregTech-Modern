...
public class AutoEatModule extends ItemModule {
    ...
    public static final Codec<AutoEatModule> CODEC = simpleCodec(AutoEatModule::new);

    public AutoEatModule(boolean isEnabled, ItemStack moduleItem) {
        super(isEnabled, moduleItem);
    }

    public AutoEatModule(ItemStack moduleItem) {
        super(moduleItem);
    }

    @Override
    public ItemModuleType type() {
        return GTItemModules.AUTO_EAT;
    }
