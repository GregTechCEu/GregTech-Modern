...
public class GTNetwork {
    ...
    public static void registerPayloads(RegisterPayloadHandlersEvent event) {
        ...
        // spotless:off
        registar.playBidirectional(SCPacketMonitorGroupNBTChange.TYPE, SCPacketMonitorGroupNBTChange.CODEC,
                SCPacketMonitorGroupNBTChange::execute);
        ...
        registar.playToClient(SPacketStartProspectionShare.TYPE, SPacketStartProspectionShare.CODEC,
                SPacketStartProspectionShare::execute);
    }
}
