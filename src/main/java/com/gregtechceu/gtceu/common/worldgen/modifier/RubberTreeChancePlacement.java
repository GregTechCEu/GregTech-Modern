...
public class RubberTreeChancePlacement extends RepeatingPlacement {
    ...
    public static final PlacementModifierType<RubberTreeChancePlacement> RUBBER_TREE_CHANCE_PLACEMENT = GTRegistries.register(
            BuiltInRegistries.PLACEMENT_MODIFIER_TYPE, GTCEu.id("rubber_tree_chance"), () -> RubberTreeChancePlacement.CODEC);
