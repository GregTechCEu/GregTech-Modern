...
import com.gregtechceu.gtceu.integration.jm.JourneyMapPlugin;
...
public class CommonProxy {
    public CommonProxy() {
        ...
        // init journey map comp
        JourneyMapPlugin.init(eventBus);
    }
    ...
    public void loadComplete(FMLLoadCompleteEvent e) {
        e.enqueueWork(() -> {
            ...
            if (LDLib.isModLoaded(GTValues.MODID_XAEROSWORLDMAP)) {
                GTCEu.LOGGER.info("Xaero's world map found. Enabling integration...");
                XaerosWorldMapPlugin.init();
            }
        });
    }
