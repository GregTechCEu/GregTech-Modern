...
public class DataAccessHatchMachine extends TieredPartMachine
    ...
    public List<Component> getDataInfo(PortableScannerBehavior.DisplayMode mode) {
        if (mode == PortableScannerBehavior.DisplayMode.SHOW_ALL ||
            ...
            list.add(Component.translatable("item.gtceu.behavior.data_item.title",
            ...
            for (GTRecipe recipe : recipes) {
                ...
                if (!itemsAdded.contains(stack)) {
                    ...
                    list.add(Component.translatable("item.gtceu.behavior.data_item.data", stack.getDisplayName()));
                }
            }
            return list;
        }
