...
public class HullMachine extends TieredPartMachine {
    ...
    public void onLoad() {
        super.onLoad();
        if (GTCEuAPI.Mods.isAE2Loaded() && gridNodeHost instanceof GridNodeHostTrait connectedBlockEntity &&
    ...
    public void saveCustomPersistedData(@NotNull CompoundTag tag, boolean forDrop) {
        ...
        if (GTCEuAPI.Mods.isAE2Loaded() && gridNodeHost instanceof IGridConnectedBlockEntity connectedBlockEntity) {
