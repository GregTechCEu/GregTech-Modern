...
final class CreativeTankMachineUI {
    ...
    static Object createUIWidget(CreativeTankMachine machine) {
        ...
        group.addWidget(new TextFieldWidget(9, 47, 152, 10, () -> String.valueOf(machine.mBPerCycle),
                machine::setmBPerCycle)
        ...
        group.addWidget(new TextFieldWidget(9, 84, 152, 10, () -> String.valueOf(machine.ticksPerCycle),
