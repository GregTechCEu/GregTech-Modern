...
public class CreativeChestMachine extends QuantumChestMachine {
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new TextFieldWidget(9, 50, 152, 10, () -> String.valueOf(itemsPerCycle),
                this::setItemsPerCycle)
        ...
        group.addWidget(new TextFieldWidget(9, 87, 152, 10, () -> String.valueOf(ticksPerCycle),
